...
T = TypeVar("T", bound="CreateBimBatchTrimElementRequestRequest")


@_attrs_define
class CreateBimBatchTrimElementRequestRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_bim_batch_trim_element_request_request = cls(
            ids=ids,
            trim_query=trim_query,
        )

        create_bim_batch_trim_element_request_request.additional_properties = d
        return create_bim_batch_trim_element_request_request
