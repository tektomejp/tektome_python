...
T = TypeVar("T", bound="DataspaceFuzzySearchConfigurationGetOut")


@_attrs_define
class DataspaceFuzzySearchConfigurationGetOut:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        for excluded_project_attributes_item_data in self.excluded_project_attributes:
            excluded_project_attributes_item = excluded_project_attributes_item_data.to_dict()
            excluded_project_attributes.append(excluded_project_attributes_item)

        excluded_resource_attributes = []
        for excluded_resource_attributes_item_data in self.excluded_resource_attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for excluded_project_attributes_item_data in _excluded_project_attributes:
            excluded_project_attributes_item = DataspaceProjectAttributePostOut.from_dict(
        ...
        for excluded_resource_attributes_item_data in _excluded_resource_attributes:
            excluded_resource_attributes_item = DataspaceResourceFileAttributePostOut.from_dict(
        ...
        dataspace_fuzzy_search_configuration_get_out = cls(
            created_by=created_by,
            updated_by=updated_by,
            excluded_project_attributes=excluded_project_attributes,
            excluded_resource_attributes=excluded_resource_attributes,
        ...
        dataspace_fuzzy_search_configuration_get_out.additional_properties = d
        return dataspace_fuzzy_search_configuration_get_out
