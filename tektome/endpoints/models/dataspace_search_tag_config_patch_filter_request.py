...
T = TypeVar("T", bound="DataspaceSearchTagConfigPatchFilterRequest")


@_attrs_define
class DataspaceSearchTagConfigPatchFilterRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_search_tag_config_patch_filter_request = cls(
            filter_ids=filter_ids,
        )

        dataspace_search_tag_config_patch_filter_request.additional_properties = d
        return dataspace_search_tag_config_patch_filter_request
