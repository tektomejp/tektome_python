...
T = TypeVar("T", bound="ImageCitationPolygonAnnotationResponse")


@_attrs_define
class ImageCitationPolygonAnnotationResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_citation_polygon_annotation_response = cls(
            bounding_geometry=bounding_geometry,
            id=id,
            capture=capture,
            status=status,
        ...
        image_citation_polygon_annotation_response.additional_properties = d
        return image_citation_polygon_annotation_response
