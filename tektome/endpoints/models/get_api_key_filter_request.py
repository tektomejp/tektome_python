...
T = TypeVar("T", bound="GetAPIKeyFilterRequest")


@_attrs_define
class GetAPIKeyFilterRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_api_key_filter_request = cls(
            include_system=include_system,
            include_expired=include_expired,
        )

        get_api_key_filter_request.additional_properties = d
        return get_api_key_filter_request
