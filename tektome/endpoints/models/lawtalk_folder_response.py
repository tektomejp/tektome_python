...
T = TypeVar("T", bound="LawtalkFolderResponse")


@_attrs_define
class LawtalkFolderResponse:
    """
    Attributes:
        core_attributes (FolderRequiredSchema): Folder required schema
        is_root (bool):
        resources (list[LawtalkResourceSchema]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_folder_response.additional_properties = d
        return lawtalk_folder_response
