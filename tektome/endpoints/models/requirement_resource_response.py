...
T = TypeVar("T", bound="RequirementResourceResponse")


@_attrs_define
class RequirementResourceResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        requirement_resource_response = cls(
            core_attributes=core_attributes,
            id=id,
        )

        requirement_resource_response.additional_properties = d
        return requirement_resource_response
