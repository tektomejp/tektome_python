...
T = TypeVar("T", bound="CreateRequirementTemplateRequest")


@_attrs_define
class CreateRequirementTemplateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_requirement_template_request = cls(
            title=title,
            status=status,
            requirement_item_attribute_table=requirement_item_attribute_table,
        )

        create_requirement_template_request.additional_properties = d
        return create_requirement_template_request
