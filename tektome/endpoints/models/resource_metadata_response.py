...
T = TypeVar("T", bound="ResourceMetadataResponse")
...
class ResourceMetadataResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resource_metadata_response = cls(
            core_attributes=core_attributes,
            folder_id=folder_id,
            created=created,
            updated=updated,
        ...
        resource_metadata_response.additional_properties = d
        return resource_metadata_response
