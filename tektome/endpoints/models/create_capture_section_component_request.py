...
T = TypeVar("T", bound="CreateCaptureSectionComponentRequest")


@_attrs_define
class CreateCaptureSectionComponentRequest:
    """
    Attributes:
        resource_id (UUID):
        page_number (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_capture_section_component_request = cls(
            resource_id=resource_id,
            page_number=page_number,
            bounding_geometry=bounding_geometry,
        )

        create_capture_section_component_request.additional_properties = d
        return create_capture_section_component_request
