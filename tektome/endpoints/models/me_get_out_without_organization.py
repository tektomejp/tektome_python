...
if TYPE_CHECKING:
    from ..models.assigned_role_schema_response import AssignedRoleSchemaResponse
    from ..models.current_organization_schema import CurrentOrganizationSchema


T = TypeVar("T", bound="MeGetOutWithoutOrganization")


@_attrs_define
class MeGetOutWithoutOrganization:
    """
    Attributes:
        ...
        role_assignments (list[AssignedRoleSchemaResponse] | Unset):
    """
    ...
    role_assignments: list[AssignedRoleSchemaResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _role_assignments is not UNSET:
            ...
            for role_assignments_item_data in _role_assignments:
                role_assignments_item = AssignedRoleSchemaResponse.from_dict(role_assignments_item_data)
        ...
        return me_get_out_without_organization
