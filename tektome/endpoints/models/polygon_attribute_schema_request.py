...
T = TypeVar("T", bound="PolygonAttributeSchemaRequest")


@_attrs_define
class PolygonAttributeSchemaRequest:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        polygon_attribute_schema_request = cls(
            name=name,
            value=value,
        )

        polygon_attribute_schema_request.additional_properties = d
        return polygon_attribute_schema_request
