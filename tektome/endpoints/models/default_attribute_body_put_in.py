...
if TYPE_CHECKING:
    ...
    from ..models.default_attribute_body_put_in_list_object_attributes_item import (
...
class DefaultAttributeBodyPutIn:
    ...
    Attributes:
        ...
        list_object_attributes (list[DefaultAttributeBodyPutInListObjectAttributesItem] | Unset):
    ...
    list_object_attributes: list[DefaultAttributeBodyPutInListObjectAttributesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _list_object_attributes is not UNSET:
            ...
            for list_object_attributes_item_data in _list_object_attributes:
                list_object_attributes_item = DefaultAttributeBodyPutInListObjectAttributesItem.from_dict(
