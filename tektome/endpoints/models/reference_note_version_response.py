...
T = TypeVar("T", bound="ReferenceNoteVersionResponse")


@_attrs_define
class ReferenceNoteVersionResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reference_note_version_response = cls(
            approvals=approvals,
            created_by=created_by,
            updated_by=updated_by,
            core_attributes=core_attributes,
        ...
        reference_note_version_response.additional_properties = d
        return reference_note_version_response
