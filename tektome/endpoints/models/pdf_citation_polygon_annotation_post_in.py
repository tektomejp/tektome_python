...
T = TypeVar("T", bound="PDFCitationPolygonAnnotationPostIn")


@_attrs_define
class PDFCitationPolygonAnnotationPostIn:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pdf_citation_polygon_annotation_post_in = cls(
            page_id=page_id,
            attribute_type=attribute_type,
            bounding_geometry=bounding_geometry,
        )

        pdf_citation_polygon_annotation_post_in.additional_properties = d
        return pdf_citation_polygon_annotation_post_in
