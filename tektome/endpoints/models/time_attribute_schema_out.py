...
T = TypeVar("T", bound="TimeAttributeSchemaOut")


@_attrs_define
class TimeAttributeSchemaOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_attribute_schema_out.additional_properties = d
        return time_attribute_schema_out
