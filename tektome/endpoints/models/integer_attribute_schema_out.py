...
T = TypeVar("T", bound="IntegerAttributeSchemaOut")


@_attrs_define
class IntegerAttributeSchemaOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integer_attribute_schema_out = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        integer_attribute_schema_out.additional_properties = d
        return integer_attribute_schema_out
