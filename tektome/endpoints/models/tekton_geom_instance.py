...
T = TypeVar("T", bound="TektonGeomInstance")


@_attrs_define
class TektonGeomInstance:
    """
    Attributes:
        geometry (Geometry):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tekton_geom_instance.additional_properties = d
        return tekton_geom_instance
