...
if TYPE_CHECKING:
    from ..models.base_annotated_polygon_schema_response import BaseAnnotatedPolygonSchemaResponse


T = TypeVar("T", bound="ImageCitationSchemaResponse")


@_attrs_define
class ImageCitationSchemaResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for polygons_item_data in _polygons:
            polygons_item = BaseAnnotatedPolygonSchemaResponse.from_dict(polygons_item_data)
        ...
        return image_citation_schema_response
