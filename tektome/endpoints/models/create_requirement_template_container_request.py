...
T = TypeVar("T", bound="CreateRequirementTemplateContainerRequest")


@_attrs_define
class CreateRequirementTemplateContainerRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_requirement_template_container_request = cls(
            name=name,
            organization_id=organization_id,
        ...
        create_requirement_template_container_request.additional_properties = d
        return create_requirement_template_container_request
