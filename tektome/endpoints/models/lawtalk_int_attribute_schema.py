...
T = TypeVar("T", bound="LawtalkIntAttributeSchema")


@_attrs_define
class LawtalkIntAttributeSchema:
    """
    Attributes:
        name (str):
        value (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_int_attribute_schema = cls(
            name=name,
            value=value,
            operator=operator,
        )

        lawtalk_int_attribute_schema.additional_properties = d
        return lawtalk_int_attribute_schema
