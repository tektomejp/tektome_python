...
T = TypeVar("T", bound="DataspaceMembersSchemaResponse")


@_attrs_define
class DataspaceMembersSchemaResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_members_schema_response = cls(
            id=id,
            first_name=first_name,
            last_name=last_name,
            email=email,
        ...
        dataspace_members_schema_response.additional_properties = d
        return dataspace_members_schema_response
