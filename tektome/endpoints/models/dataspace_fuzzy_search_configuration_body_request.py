...
T = TypeVar("T", bound="DataspaceFuzzySearchConfigurationBodyRequest")


@_attrs_define
class DataspaceFuzzySearchConfigurationBodyRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_fuzzy_search_configuration_body_request = cls(
        ...
        dataspace_fuzzy_search_configuration_body_request.additional_properties = d
        return dataspace_fuzzy_search_configuration_body_request
