...
if TYPE_CHECKING:
    from ..models.single_select_attribute_schema_response_value_type_0 import (
        SingleSelectAttributeSchemaResponseValueType0,
    )


T = TypeVar("T", bound="SingleSelectAttributeSchemaResponse")


@_attrs_define
class SingleSelectAttributeSchemaResponse:
    """
    Attributes:
        created (datetime.datetime):
        updated (datetime.datetime):
        name (str):
        attribute_type (Literal['single_select_attributes'] | Unset):  Default: 'single_select_attributes'.
        id (None | Unset | UUID):
        ...
        value (None | SingleSelectAttributeSchemaResponseValueType0 | Unset):
    """

    created: datetime.datetime
    updated: datetime.datetime
    name: str
    attribute_type: Literal["single_select_attributes"] | Unset = "single_select_attributes"
    ...
    value: None | SingleSelectAttributeSchemaResponseValueType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, SingleSelectAttributeSchemaResponseValueType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attribute_type = cast(Literal["single_select_attributes"] | Unset, d.pop("attribute_type", UNSET))
        if attribute_type != "single_select_attributes" and not isinstance(attribute_type, Unset):
            raise ValueError(f"attribute_type must match const 'single_select_attributes', got '{attribute_type}'")
        ...
        def _parse_value(data: object) -> None | SingleSelectAttributeSchemaResponseValueType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = SingleSelectAttributeSchemaResponseValueType0.from_dict(data)

                return value_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SingleSelectAttributeSchemaResponseValueType0 | Unset, data)

        value = _parse_value(d.pop("value", UNSET))

        single_select_attribute_schema_response = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        single_select_attribute_schema_response.additional_properties = d
        return single_select_attribute_schema_response
