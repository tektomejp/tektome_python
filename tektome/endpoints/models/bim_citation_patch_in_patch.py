...
class BIMCitationPatchInPatch:
    ...
    Attributes:
        ...
        bim_elements (list[BIMElementIn] | None | Unset):
    """

    title: None | str | Unset = UNSET
    keywords: list[str] | None | Unset = UNSET
    bim_elements: list[BIMElementIn] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_bim_elements(data: object) -> list[BIMElementIn] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for bim_elements_type_0_item_data in _bim_elements_type_0:
                    bim_elements_type_0_item = BIMElementIn.from_dict(bim_elements_type_0_item_data)
                ...
                pass
            return cast(list[BIMElementIn] | None | Unset, data)
