...
T = TypeVar("T", bound="DynamicTimeSearchCondition")


@_attrs_define
class DynamicTimeSearchCondition:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        value = DynamicTimeValue.from_dict(d.pop("value"))

        dynamic_time_search_condition = cls(
            attribute_name=attribute_name,
            attribute_type=attribute_type,
            action=action,
            value=value,
        ...
        dynamic_time_search_condition.additional_properties = d
        return dynamic_time_search_condition
