...
T = TypeVar("T", bound="RequirementResourceGetOut")


@_attrs_define
class RequirementResourceGetOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        requirement_resource_get_out = cls(
            core_attributes=core_attributes,
            id=id,
        )

        requirement_resource_get_out.additional_properties = d
        return requirement_resource_get_out
