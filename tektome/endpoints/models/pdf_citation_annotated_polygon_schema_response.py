...
T = TypeVar("T", bound="PDFCitationAnnotatedPolygonSchemaResponse")


@_attrs_define
class PDFCitationAnnotatedPolygonSchemaResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pdf_citation_annotated_polygon_schema_response = cls(
            bounding_geometry=bounding_geometry,
            page_number=page_number,
            capture=capture,
            id=id,
        ...
        pdf_citation_annotated_polygon_schema_response.additional_properties = d
        return pdf_citation_annotated_polygon_schema_response
