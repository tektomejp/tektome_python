...
T = TypeVar("T", bound="PostPDFCitationPath")


@_attrs_define
class PostPDFCitationPath:
    """
    Attributes:
        attribute_id (UUID):
        dataspace_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_pdf_citation_path.additional_properties = d
        return post_pdf_citation_path
