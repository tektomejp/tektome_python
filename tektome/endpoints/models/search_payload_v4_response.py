...
T = TypeVar("T", bound="SearchPayloadV4Response")


@_attrs_define
class SearchPayloadV4Response:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_payload_v4_response = cls(
            tektome_response=tektome_response,
            parsed_tektome_response=parsed_tektome_response,
        )

        search_payload_v4_response.additional_properties = d
        return search_payload_v4_response
