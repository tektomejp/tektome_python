...
T = TypeVar("T", bound="IntegerAttributeCandidatePayload")


@_attrs_define
class IntegerAttributeCandidatePayload:
    """
    Attributes:
        ...
        value (int | None | Unset): The integer attribute value.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integer_attribute_candidate_payload = cls(
        ...
        integer_attribute_candidate_payload.additional_properties = d
        return integer_attribute_candidate_payload
