...
T = TypeVar("T", bound="TtosFolderResponse")


@_attrs_define
class TtosFolderResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ttos_folder_response.additional_properties = d
        return ttos_folder_response
