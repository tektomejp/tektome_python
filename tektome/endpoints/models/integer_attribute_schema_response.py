...
T = TypeVar("T", bound="IntegerAttributeSchemaResponse")


@_attrs_define
class IntegerAttributeSchemaResponse:
    """
    Attributes:
        created (datetime.datetime):
        updated (datetime.datetime):
        name (str):
        attribute_type (Literal['integer_attributes'] | Unset):  Default: 'integer_attributes'.
        id (None | Unset | UUID):
    ...
    updated: datetime.datetime
    name: str
    attribute_type: Literal["integer_attributes"] | Unset = "integer_attributes"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attribute_type = cast(Literal["integer_attributes"] | Unset, d.pop("attribute_type", UNSET))
        if attribute_type != "integer_attributes" and not isinstance(attribute_type, Unset):
            raise ValueError(f"attribute_type must match const 'integer_attributes', got '{attribute_type}'")
        ...
        integer_attribute_schema_response = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        integer_attribute_schema_response.additional_properties = d
        return integer_attribute_schema_response
