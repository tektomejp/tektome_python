...
class TemplateRequest:
    """Schema for creating a new template directly (without an artifact).
    ...
    Attributes:
        ...
        artifact_id (None | Unset | UUID): The ID of the artifact to create or update the template from.
    """
        ...
        def _parse_openflow_json(data: object) -> str | TemplateRequestOpenflowJsonType1:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                openflow_json_type_1 = TemplateRequestOpenflowJsonType1.from_dict(data)

                return openflow_json_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(str | TemplateRequestOpenflowJsonType1, data)
