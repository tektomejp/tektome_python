...
T = TypeVar("T", bound="BlobUploadRequestResponse")


@_attrs_define
class BlobUploadRequestResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        blob_upload_request_response = cls(
            upload_id=upload_id,
            upload_url=upload_url,
            blob_path=blob_path,
            expires_at=expires_at,
        ...
        blob_upload_request_response.additional_properties = d
        return blob_upload_request_response
