...
T = TypeVar("T", bound="LawtalkResourceSchema")


@_attrs_define
class LawtalkResourceSchema:
    """
    Attributes:
        file (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_resource_schema.additional_properties = d
        return lawtalk_resource_schema
