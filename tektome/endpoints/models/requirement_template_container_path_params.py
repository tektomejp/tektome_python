...
T = TypeVar("T", bound="RequirementTemplateContainerPathParams")


@_attrs_define
class RequirementTemplateContainerPathParams:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        requirement_template_container_path_params = cls(
            requirement_template_container_id=requirement_template_container_id,
        )

        requirement_template_container_path_params.additional_properties = d
        return requirement_template_container_path_params
