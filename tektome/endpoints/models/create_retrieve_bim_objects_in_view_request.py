...
T = TypeVar("T", bound="CreateRetrieveBimObjectsInViewRequest")


@_attrs_define
class CreateRetrieveBimObjectsInViewRequest:
    """
    Attributes:
        bim_project_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_retrieve_bim_objects_in_view_request = cls(
            bim_project_id=bim_project_id,
            only_ids=only_ids,
        ...
        create_retrieve_bim_objects_in_view_request.additional_properties = d
        return create_retrieve_bim_objects_in_view_request
