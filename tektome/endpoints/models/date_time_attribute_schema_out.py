...
T = TypeVar("T", bound="DateTimeAttributeSchemaOut")


@_attrs_define
class DateTimeAttributeSchemaOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        date_time_attribute_schema_out = cls(
            created=created,
            updated=updated,
            name=name,
            id=id,
        ...
        date_time_attribute_schema_out.additional_properties = d
        return date_time_attribute_schema_out
