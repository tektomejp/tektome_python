...
@_attrs_define
class CreateLawtalkRequirementChatRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_lawtalk_requirement_chat_request = cls(
            prompt=prompt,
            recipe=recipe,
            requirement_id=requirement_id,
        ...
        create_lawtalk_requirement_chat_request.additional_properties = d
        return create_lawtalk_requirement_chat_request
