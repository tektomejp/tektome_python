...
T = TypeVar("T", bound="RecommendResourceGroupSchema")


@_attrs_define
class RecommendResourceGroupSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recommend_resource_group_schema = cls(
            lawtalk_attributes=lawtalk_attributes,
            core_attributes=core_attributes,
            score=score,
            imported=imported,
        ...
        recommend_resource_group_schema.additional_properties = d
        return recommend_resource_group_schema
