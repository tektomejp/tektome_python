...
T = TypeVar("T", bound="UpdatePDFCitationRequest")


@_attrs_define
class UpdatePDFCitationRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_pdf_citation_request = cls(
            title=title,
            keywords=keywords,
            overlay_html=overlay_html,
        )

        update_pdf_citation_request.additional_properties = d
        return update_pdf_citation_request
