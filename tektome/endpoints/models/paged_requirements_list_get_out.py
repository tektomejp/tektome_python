...
if TYPE_CHECKING:
    from ..models.requirements_list_response import RequirementsListResponse
...
class PagedRequirementsListGetOut:
    ...
    Attributes:
        count (int):
        total_page (int):
        items (list[RequirementsListResponse]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = RequirementsListResponse.from_dict(items_item_data)
