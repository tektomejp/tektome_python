...
T = TypeVar("T", bound="BimObjectResponse")


@_attrs_define
class BimObjectResponse:
    """Response schema for the BimObjectPostOut schema.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bim_object_response = cls(
            process_id=process_id,
        )

        bim_object_response.additional_properties = d
        return bim_object_response
