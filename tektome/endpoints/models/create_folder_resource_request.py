...
T = TypeVar("T", bound="CreateFolderResourceRequest")


@_attrs_define
class CreateFolderResourceRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_folder_resource_request = cls(
            resource_ids=resource_ids,
        )

        create_folder_resource_request.additional_properties = d
        return create_folder_resource_request
