...
T = TypeVar("T", bound="ResourceVCWithVersionSchemaPathRequest")


@_attrs_define
class ResourceVCWithVersionSchemaPathRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resource_vc_with_version_schema_path_request = cls(
            resource_group_id=resource_group_id,
            resource_vc_id=resource_vc_id,
            version_num=version_num,
        )

        resource_vc_with_version_schema_path_request.additional_properties = d
        return resource_vc_with_version_schema_path_request
