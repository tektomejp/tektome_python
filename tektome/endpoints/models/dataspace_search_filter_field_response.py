...
T = TypeVar("T", bound="DataspaceSearchFilterFieldResponse")


@_attrs_define
class DataspaceSearchFilterFieldResponse:
    ...
    Attributes:
        ...
        recommended_values (DataspaceSearchFilterFieldResponseRecommendedValuesType0 | None | Unset):
    """
    ...
    recommended_values: DataspaceSearchFilterFieldResponseRecommendedValuesType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.recommended_values, DataspaceSearchFilterFieldResponseRecommendedValuesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_recommended_values(
            data: object,
        ) -> DataspaceSearchFilterFieldResponseRecommendedValuesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                recommended_values_type_0 = DataspaceSearchFilterFieldResponseRecommendedValuesType0.from_dict(data)

                return recommended_values_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DataspaceSearchFilterFieldResponseRecommendedValuesType0 | None | Unset, data)

        recommended_values = _parse_recommended_values(d.pop("recommended_values", UNSET))

        dataspace_search_filter_field_response = cls(
            created_by=created_by,
            updated_by=updated_by,
            project_attributes=project_attributes,
            resource_attributes=resource_attributes,
        ...
        dataspace_search_filter_field_response.additional_properties = d
        return dataspace_search_filter_field_response
