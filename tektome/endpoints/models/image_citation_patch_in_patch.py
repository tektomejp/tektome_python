...
T = TypeVar("T", bound="ImageCitationPatchInPatch")


@_attrs_define
class ImageCitationPatchInPatch:
    """
    Attributes:
        title (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_citation_patch_in_patch = cls(
            title=title,
        ...
        image_citation_patch_in_patch.additional_properties = d
        return image_citation_patch_in_patch
