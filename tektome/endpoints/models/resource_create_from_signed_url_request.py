...
T = TypeVar("T", bound="ResourceCreateFromSignedUrlRequest")


@_attrs_define
class ResourceCreateFromSignedUrlRequest:
    """
    Attributes:
        url (str):
        resource_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resource_create_from_signed_url_request = cls(
            url=url,
            resource_id=resource_id,
            bim_project_name=bim_project_name,
        )

        resource_create_from_signed_url_request.additional_properties = d
        return resource_create_from_signed_url_request
