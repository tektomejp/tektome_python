...
class CreateOrganizationMultiPartBodyParams:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_organization_multi_part_body_params = cls(
            payload=payload,
            logo_file=logo_file,
        )

        create_organization_multi_part_body_params.additional_properties = d
        return create_organization_multi_part_body_params
