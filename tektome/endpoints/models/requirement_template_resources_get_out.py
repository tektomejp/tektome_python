...
T = TypeVar("T", bound="RequirementTemplateResourcesGetOut")


@_attrs_define
class RequirementTemplateResourcesGetOut:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        requirement_template_resources_get_out = cls(
            core_attributes=core_attributes,
            lawtalk_attributes=lawtalk_attributes,
            created=created,
            updated=updated,
        ...
        requirement_template_resources_get_out.additional_properties = d
        return requirement_template_resources_get_out
