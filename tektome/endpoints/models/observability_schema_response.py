...
T = TypeVar("T", bound="ObservabilitySchemaResponse")


@_attrs_define
class ObservabilitySchemaResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        observability_schema_response = cls(
            created=created,
            updated=updated,
            observed_entity=observed_entity,
            scoping_entity=scoping_entity,
        ...
        observability_schema_response.additional_properties = d
        return observability_schema_response
