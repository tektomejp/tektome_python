...
T = TypeVar("T", bound="SimpleAttributeTypeActionSchemaTimeNotEquals")


@_attrs_define
class SimpleAttributeTypeActionSchemaTimeNotEquals:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        simple_attribute_type_action_schema_time_not_equals.additional_properties = d
        return simple_attribute_type_action_schema_time_not_equals
