...
T = TypeVar("T", bound="GenBreadcrumbsResourceGroupResponse")


@_attrs_define
class GenBreadcrumbsResourceGroupResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gen_breadcrumbs_resource_group_response = cls(
            core_attributes=core_attributes,
            id=id,
        )

        gen_breadcrumbs_resource_group_response.additional_properties = d
        return gen_breadcrumbs_resource_group_response
