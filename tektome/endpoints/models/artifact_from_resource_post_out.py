...
T = TypeVar("T", bound="ArtifactFromResourcePostOut")


@_attrs_define
class ArtifactFromResourcePostOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        artifact_from_resource_post_out = cls(
            created=created,
            updated=updated,
            chatroom=chatroom,
            path=path,
        ...
        artifact_from_resource_post_out.additional_properties = d
        return artifact_from_resource_post_out
