...
T = TypeVar("T", bound="DynamicBooleanValue")


@_attrs_define
class DynamicBooleanValue:
    """
    Attributes:
        entity (EntityType):
        ...
        attribute_type (Literal['boolean']): The type of the attribute to filter on
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dynamic_boolean_value.additional_properties = d
        return dynamic_boolean_value
