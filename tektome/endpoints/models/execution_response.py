...
if TYPE_CHECKING:
    ...
    from ..models.execution_response_execution_run_args import ExecutionResponseExecutionRunArgs
...
class ExecutionResponse:
    ...
    Attributes:
        execution_run_args (ExecutionResponseExecutionRunArgs):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        execution_run_args = ExecutionResponseExecutionRunArgs.from_dict(d.pop("execution_run_args"))
