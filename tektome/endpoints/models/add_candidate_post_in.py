...
T = TypeVar("T", bound="AddCandidatePostIn")


@_attrs_define
class AddCandidatePostIn:
    """Serializer for adding a new candidate variation to an existing approval ticket
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_candidate_post_in = cls(
            data=data,
            kind=kind,
        )

        add_candidate_post_in.additional_properties = d
        return add_candidate_post_in
