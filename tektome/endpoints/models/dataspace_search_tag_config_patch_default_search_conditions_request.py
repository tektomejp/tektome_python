...
T = TypeVar("T", bound="DataspaceSearchTagConfigPatchDefaultSearchConditionsRequest")


@_attrs_define
class DataspaceSearchTagConfigPatchDefaultSearchConditionsRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_search_tag_config_patch_default_search_conditions_request = cls(
            default_search_conditions=default_search_conditions,
        )

        dataspace_search_tag_config_patch_default_search_conditions_request.additional_properties = d
        return dataspace_search_tag_config_patch_default_search_conditions_request
