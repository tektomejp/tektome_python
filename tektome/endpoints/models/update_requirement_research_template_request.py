...
T = TypeVar("T", bound="UpdateRequirementResearchTemplateRequest")


@_attrs_define
class UpdateRequirementResearchTemplateRequest:
    """
    Attributes:
        name (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_requirement_research_template_request = cls(
            name=name,
            prompt=prompt,
        ...
        update_requirement_research_template_request.additional_properties = d
        return update_requirement_research_template_request
