...
T = TypeVar("T", bound="PDFPolygonSchemaRequest")


@_attrs_define
class PDFPolygonSchemaRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pdf_polygon_schema_request = cls(
            page_id=page_id,
            bounding_geometry=bounding_geometry,
        )

        pdf_polygon_schema_request.additional_properties = d
        return pdf_polygon_schema_request
