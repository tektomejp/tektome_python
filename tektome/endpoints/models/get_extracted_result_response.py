...
T = TypeVar("T", bound="GetExtractedResultResponse")


@_attrs_define
class GetExtractedResultResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_extracted_result_response = cls(
            extraction_status=extraction_status,
            value=value,
            error_message=error_message,
            reasoning=reasoning,
        ...
        get_extracted_result_response.additional_properties = d
        return get_extracted_result_response
