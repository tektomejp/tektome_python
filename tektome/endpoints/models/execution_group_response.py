...
T = TypeVar("T", bound="ExecutionGroupResponse")


@_attrs_define
class ExecutionGroupResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for processes_details_item_data in _processes_details:
            processes_details_item = ExecutionProcessResponse.from_dict(processes_details_item_data)
        ...
        execution_group_response.additional_properties = d
        return execution_group_response
