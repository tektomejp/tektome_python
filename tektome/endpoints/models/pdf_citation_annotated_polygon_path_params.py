...
T = TypeVar("T", bound="PDFCitationAnnotatedPolygonPathParams")


@_attrs_define
class PDFCitationAnnotatedPolygonPathParams:
    """
    Attributes:
        attribute_id (UUID):
        dataspace_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pdf_citation_annotated_polygon_path_params = cls(
            attribute_id=attribute_id,
            dataspace_id=dataspace_id,
            attribute_category=attribute_category,
            pdf_citation_id=pdf_citation_id,
        ...
        pdf_citation_annotated_polygon_path_params.additional_properties = d
        return pdf_citation_annotated_polygon_path_params
