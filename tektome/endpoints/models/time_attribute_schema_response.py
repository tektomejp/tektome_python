...
T = TypeVar("T", bound="TimeAttributeSchemaResponse")


@_attrs_define
class TimeAttributeSchemaResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_attribute_schema_response = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        time_attribute_schema_response.additional_properties = d
        return time_attribute_schema_response
