...
if TYPE_CHECKING:
    ...
    from ..models.file_table_attribute import FileTableAttribute


T = TypeVar("T", bound="FileTableAttributeExtraction")


@_attrs_define
class FileTableAttributeExtraction:
    """
    Attributes:
        model_name (LargeLanguageModelEnum):
        embedding_model (EmbeddingModelEnum):
        documents (Documents):
        attribute (FileTableAttribute):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attribute = FileTableAttribute.from_dict(d.pop("attribute"))
        ...
        file_table_attribute_extraction = cls(
            model_name=model_name,
            embedding_model=embedding_model,
            documents=documents,
            attribute=attribute,
        ...
        file_table_attribute_extraction.additional_properties = d
        return file_table_attribute_extraction
