...
T = TypeVar("T", bound="BimProjectStatsResponse")


@_attrs_define
class BimProjectStatsResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bim_project_stats_response = cls(
            id=id,
            name=name,
            created_at=created_at,
            modified_at=modified_at,
        ...
        bim_project_stats_response.additional_properties = d
        return bim_project_stats_response
