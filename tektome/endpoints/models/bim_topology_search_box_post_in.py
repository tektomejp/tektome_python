...
T = TypeVar("T", bound="BimTopologySearchBoxPostIn")


@_attrs_define
class BimTopologySearchBoxPostIn:
    """Schema for BIM topology search with box request.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        min_boundary = self.min_boundary.to_dict()

        max_boundary = self.max_boundary.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        min_boundary = Boundary.from_dict(d.pop("min_boundary"))

        max_boundary = Boundary.from_dict(d.pop("max_boundary"))

        strict_contains = d.pop("strict_contains", UNSET)

        use_vertices = d.pop("use_vertices", UNSET)

        bim_topology_search_box_post_in = cls(
            bim_object_ids=bim_object_ids,
            min_boundary=min_boundary,
            max_boundary=max_boundary,
        ...
        bim_topology_search_box_post_in.additional_properties = d
        return bim_topology_search_box_post_in
