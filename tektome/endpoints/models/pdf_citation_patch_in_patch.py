...
T = TypeVar("T", bound="PDFCitationPatchInPatch")


@_attrs_define
class PDFCitationPatchInPatch:
    """
    Attributes:
        title (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pdf_citation_patch_in_patch = cls(
            title=title,
        ...
        pdf_citation_patch_in_patch.additional_properties = d
        return pdf_citation_patch_in_patch
