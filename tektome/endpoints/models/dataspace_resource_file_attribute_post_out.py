...
T = TypeVar("T", bound="DataspaceResourceFileAttributePostOut")


@_attrs_define
class DataspaceResourceFileAttributePostOut:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_resource_file_attribute_post_out = cls(
            created_by=created_by,
            updated_by=updated_by,
            attribute_name=attribute_name,
            attribute_type=attribute_type,
        ...
        dataspace_resource_file_attribute_post_out.additional_properties = d
        return dataspace_resource_file_attribute_post_out
