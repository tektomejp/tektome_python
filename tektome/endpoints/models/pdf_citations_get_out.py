...
T = TypeVar("T", bound="PDFCitationsGetOut")


@_attrs_define
class PDFCitationsGetOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pdf_citations_get_out.additional_properties = d
        return pdf_citations_get_out
