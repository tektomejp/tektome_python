...
T = TypeVar("T", bound="AssignedRoleSchemaResponse")


@_attrs_define
class AssignedRoleSchemaResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assigned_role_schema_response = cls(
            role=role,
        ...
        assigned_role_schema_response.additional_properties = d
        return assigned_role_schema_response
