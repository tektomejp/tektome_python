...
T = TypeVar("T", bound="DataspaceMemberSchemaRequest")


@_attrs_define
class DataspaceMemberSchemaRequest:
    """
    Attributes:
        user_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_member_schema_request = cls(
            user_id=user_id,
            role_name=role_name,
        )

        dataspace_member_schema_request.additional_properties = d
        return dataspace_member_schema_request
