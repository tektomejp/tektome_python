...
T = TypeVar("T", bound="ResourceGroupPostOut")


@_attrs_define
class ResourceGroupPostOut:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resource_group_post_out.additional_properties = d
        return resource_group_post_out
