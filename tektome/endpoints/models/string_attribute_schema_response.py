...
T = TypeVar("T", bound="StringAttributeSchemaResponse")


@_attrs_define
class StringAttributeSchemaResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        string_attribute_schema_response = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        string_attribute_schema_response.additional_properties = d
        return string_attribute_schema_response
