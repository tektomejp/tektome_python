...
T = TypeVar("T", bound="ExecuteProcessMetadataQueryRequest")


@_attrs_define
class ExecuteProcessMetadataQueryRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        execute_process_metadata_query_request = cls(
            kind=kind,
            model_entity_ids=model_entity_ids,
        )

        execute_process_metadata_query_request.additional_properties = d
        return execute_process_metadata_query_request
