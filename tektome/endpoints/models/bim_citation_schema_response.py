...
T = TypeVar("T", bound="BIMCitationSchemaResponse")


@_attrs_define
class BIMCitationSchemaResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bim_citation_schema_response = cls(
            created_by=created_by,
            updated_by=updated_by,
            cited_bim_elements=cited_bim_elements,
            created=created,
        ...
        bim_citation_schema_response.additional_properties = d
        return bim_citation_schema_response
