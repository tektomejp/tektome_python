...
T = TypeVar("T", bound="ProjectPatchMembersSchemaRequest")


@_attrs_define
class ProjectPatchMembersSchemaRequest:
    """
    Attributes:
        user_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_patch_members_schema_request = cls(
            user_id=user_id,
            role_name=role_name,
        )

        project_patch_members_schema_request.additional_properties = d
        return project_patch_members_schema_request
