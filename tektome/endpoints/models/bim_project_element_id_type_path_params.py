...
T = TypeVar("T", bound="BimProjectElementIdTypePathParams")


@_attrs_define
class BimProjectElementIdTypePathParams:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bim_project_element_id_type_path_params = cls(
            bim_project_id=bim_project_id,
            bim_type=bim_type,
            bim_element_id=bim_element_id,
        )

        bim_project_element_id_type_path_params.additional_properties = d
        return bim_project_element_id_type_path_params
