...
T = TypeVar("T", bound="BimProjectPaginationQueryRequest")


@_attrs_define
class BimProjectPaginationQueryRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bim_project_pagination_query_request = cls(
            page=page,
            page_size=page_size,
        )

        bim_project_pagination_query_request.additional_properties = d
        return bim_project_pagination_query_request
