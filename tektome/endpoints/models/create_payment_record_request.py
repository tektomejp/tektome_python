...
T = TypeVar("T", bound="CreatePaymentRecordRequest")
...
class CreatePaymentRecordRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_payment_record_request = cls(
            transaction_type=transaction_type,
            credits_amount=credits_amount,
            notes=notes,
        )

        create_payment_record_request.additional_properties = d
        return create_payment_record_request
