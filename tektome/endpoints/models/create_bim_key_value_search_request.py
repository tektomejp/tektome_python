...
T = TypeVar("T", bound="CreateBimKeyValueSearchRequest")


@_attrs_define
class CreateBimKeyValueSearchRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_bim_key_value_search_request = cls(
            key=key,
            value=value,
            fields=fields,
            page=page,
        ...
        create_bim_key_value_search_request.additional_properties = d
        return create_bim_key_value_search_request
