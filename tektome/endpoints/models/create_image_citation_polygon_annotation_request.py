...
T = TypeVar("T", bound="CreateImageCitationPolygonAnnotationRequest")


@_attrs_define
class CreateImageCitationPolygonAnnotationRequest:
    """
    Attributes:
        ...
        bounding_geometry (list[list[float]]): List of coordinates defining the polygon. Each coordinate is a tuple of
            two floats (x, y).
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_image_citation_polygon_annotation_request = cls(
            attribute_type=attribute_type,
            bounding_geometry=bounding_geometry,
        )

        create_image_citation_polygon_annotation_request.additional_properties = d
        return create_image_citation_polygon_annotation_request
