...
if TYPE_CHECKING:
    from ..models.requirement_template_response_requirement_item_attribute_table_type_0 import (
        RequirementTemplateResponseRequirementItemAttributeTableType0,
    )
    from ..models.user_metadata import UserMetadata


T = TypeVar("T", bound="RequirementTemplateResponse")


@_attrs_define
class RequirementTemplateResponse:
    ...
    Attributes:
        ...
        requirement_item_attribute_table (None | RequirementTemplateResponseRequirementItemAttributeTableType0 | Unset):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.requirement_item_attribute_table, Unset):
            ...
            self.requirement_item_attribute_table, RequirementTemplateResponseRequirementItemAttributeTableType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_requirement_item_attribute_table(
            data: object,
        ) -> None | RequirementTemplateResponseRequirementItemAttributeTableType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                requirement_item_attribute_table_type_0 = (
                    RequirementTemplateResponseRequirementItemAttributeTableType0.from_dict(data)
                )

                return requirement_item_attribute_table_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | RequirementTemplateResponseRequirementItemAttributeTableType0 | Unset, data)

        requirement_item_attribute_table = _parse_requirement_item_attribute_table(
            d.pop("requirement_item_attribute_table", UNSET)
        )

        requirement_template_response = cls(
            created_by=created_by,
            updated_by=updated_by,
            title=title,
            created=created,
        ...
        requirement_template_response.additional_properties = d
        return requirement_template_response
