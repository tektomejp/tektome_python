...
T = TypeVar("T", bound="InstallArtifactTemplatesRequest")


@_attrs_define
class InstallArtifactTemplatesRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        install_artifact_templates_request = cls(
            group_ids=group_ids,
            on_duplicate=on_duplicate,
        )

        install_artifact_templates_request.additional_properties = d
        return install_artifact_templates_request
