...
if TYPE_CHECKING:
    ...
    from ..models.requirements_list_get_out_section_changes_since_last_summary import (
        RequirementsListGetOutSectionChangesSinceLastSummary,
    )
    from ..models.user_metadata import UserMetadata


T = TypeVar("T", bound="RequirementsListGetOut")


@_attrs_define
class RequirementsListGetOut:
    """
    Attributes:
        ...
        id (None | Unset | UUID):
        section_changes_since_last_summary (RequirementsListGetOutSectionChangesSinceLastSummary | Unset):
    """
    ...
    section_changes_since_last_summary: RequirementsListGetOutSectionChangesSinceLastSummary | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_section_changes_since_last_summary, Unset):
            ...
            section_changes_since_last_summary = RequirementsListGetOutSectionChangesSinceLastSummary.from_dict(
                _section_changes_since_last_summary
            )

        requirements_list_get_out = cls(
            core_attributes=core_attributes,
            created_by=created_by,
            updated_by=updated_by,
            saved_items=saved_items,
        ...
        requirements_list_get_out.additional_properties = d
        return requirements_list_get_out
