...
T = TypeVar("T", bound="GetImageCitationPath")


@_attrs_define
class GetImageCitationPath:
    """Path schema for retrieving an image citation.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_image_citation_path = cls(
            attribute_id=attribute_id,
            dataspace_id=dataspace_id,
            image_citation_id=image_citation_id,
        )

        get_image_citation_path.additional_properties = d
        return get_image_citation_path
