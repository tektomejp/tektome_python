...
T = TypeVar("T", bound="GenBreadcrumbsResourceGroupGetOut")


@_attrs_define
class GenBreadcrumbsResourceGroupGetOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gen_breadcrumbs_resource_group_get_out = cls(
            core_attributes=core_attributes,
            id=id,
        )

        gen_breadcrumbs_resource_group_get_out.additional_properties = d
        return gen_breadcrumbs_resource_group_get_out
