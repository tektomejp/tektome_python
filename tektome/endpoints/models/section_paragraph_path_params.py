...
T = TypeVar("T", bound="SectionParagraphPathParams")


@_attrs_define
class SectionParagraphPathParams:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        section_paragraph_path_params = cls(
            page_id=page_id,
            paragraph_indices=paragraph_indices,
        )

        section_paragraph_path_params.additional_properties = d
        return section_paragraph_path_params
