...
if TYPE_CHECKING:
    from ..models.create_run_artifact_request_body_type_0 import CreateRunArtifactRequestBodyType0


T = TypeVar("T", bound="CreateRunArtifactRequest")


@_attrs_define
class CreateRunArtifactRequest:
    """
    Attributes:
    ...
    body: CreateRunArtifactRequestBodyType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.body, Unset):
            body = UNSET
        elif isinstance(self.body, CreateRunArtifactRequestBodyType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_body(data: object) -> CreateRunArtifactRequestBodyType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                body_type_0 = CreateRunArtifactRequestBodyType0.from_dict(data)

                return body_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CreateRunArtifactRequestBodyType0 | None | Unset, data)

        body = _parse_body(d.pop("body", UNSET))

        create_run_artifact_request = cls(
            result_artifact_id=result_artifact_id,
            result_artifact_path=result_artifact_path,
            body=body,
        )

        create_run_artifact_request.additional_properties = d
        return create_run_artifact_request
