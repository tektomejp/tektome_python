...
T = TypeVar("T", bound="LawtalkProjectSchema")


@_attrs_define
class LawtalkProjectSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_project_schema.additional_properties = d
        return lawtalk_project_schema
