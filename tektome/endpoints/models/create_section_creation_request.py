...
if TYPE_CHECKING:
    from ..models.section_paragraph_path_params import SectionParagraphPathParams
    from ..models.section_table_path_params import SectionTablePathParams


T = TypeVar("T", bound="CreateSectionCreationRequest")


@_attrs_define
class CreateSectionCreationRequest:
    ...
    Attributes:
        ...
        pages_paragraphs_paths: List of SectionParagraphPath to access for paragraphs in pages.
    ...
    Note:
        ...
        Attributes:
            ...
            pages_paragraphs_paths (list[SectionParagraphPathParams] | Unset): Path to access paragraphs in pages
            pages_tables_paths (list[SectionTablePathParams] | Unset): Path to access tables in pages
    ...
    pages_paragraphs_paths: list[SectionParagraphPathParams] | Unset = UNSET
    pages_tables_paths: list[SectionTablePathParams] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _pages_paragraphs_paths is not UNSET:
            ...
            for pages_paragraphs_paths_item_data in _pages_paragraphs_paths:
                pages_paragraphs_paths_item = SectionParagraphPathParams.from_dict(pages_paragraphs_paths_item_data)
        ...
        if _pages_tables_paths is not UNSET:
            ...
            for pages_tables_paths_item_data in _pages_tables_paths:
                pages_tables_paths_item = SectionTablePathParams.from_dict(pages_tables_paths_item_data)
        ...
        create_section_creation_request = cls(
            project_id=project_id,
        ...
        create_section_creation_request.additional_properties = d
        return create_section_creation_request
