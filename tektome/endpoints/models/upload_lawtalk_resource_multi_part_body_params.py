...
@_attrs_define
class UploadLawtalkResourceMultiPartBodyParams:
    """
    Attributes:
        file (File):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        upload_lawtalk_resource_multi_part_body_params.additional_properties = d
        return upload_lawtalk_resource_multi_part_body_params
