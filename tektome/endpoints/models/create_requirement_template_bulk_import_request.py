...
T = TypeVar("T", bound="CreateRequirementTemplateBulkImportRequest")


@_attrs_define
class CreateRequirementTemplateBulkImportRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_requirement_template_bulk_import_request = cls(
            project_id=project_id,
            requirement_templates_ids=requirement_templates_ids,
        )

        create_requirement_template_bulk_import_request.additional_properties = d
        return create_requirement_template_bulk_import_request
