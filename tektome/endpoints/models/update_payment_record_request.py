...
T = TypeVar("T", bound="UpdatePaymentRecordRequest")
...
class UpdatePaymentRecordRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_payment_record_request = cls(
            transaction_type=transaction_type,
            credits_amount=credits_amount,
            notes=notes,
        )

        update_payment_record_request.additional_properties = d
        return update_payment_record_request
