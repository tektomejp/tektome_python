...
T = TypeVar("T", bound="GetSupportedDRModelsResponse")


@_attrs_define
class GetSupportedDRModelsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_supported_dr_models_response = cls(
            supported_models=supported_models,
        )

        get_supported_dr_models_response.additional_properties = d
        return get_supported_dr_models_response
