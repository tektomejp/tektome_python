...
T = TypeVar("T", bound="BlobUploadCompleteRequest")


@_attrs_define
class BlobUploadCompleteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        blob_upload_complete_request = cls(
            upload_id=upload_id,
            initialize=initialize,
        )

        blob_upload_complete_request.additional_properties = d
        return blob_upload_complete_request
