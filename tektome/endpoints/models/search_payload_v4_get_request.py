...
T = TypeVar("T", bound="SearchPayloadV4GetRequest")


@_attrs_define
class SearchPayloadV4GetRequest:
    """
    Attributes:
        query (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_payload_v4_get_request = cls(
            query=query,
            keyword=keyword,
            top_k=top_k,
            skip=skip,
        ...
        search_payload_v4_get_request.additional_properties = d
        return search_payload_v4_get_request
