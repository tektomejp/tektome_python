...
if TYPE_CHECKING:
    ...
    from ..models.dataspace_resource_file_attribute_response_attribute_metadata_type_0 import (
        DataspaceResourceFileAttributeResponseAttributeMetadataType0,
    )
    from ..models.user_metadata import UserMetadata


T = TypeVar("T", bound="DataspaceResourceFileAttributeResponse")


@_attrs_define
class DataspaceResourceFileAttributeResponse:
    ...
    Attributes:
        ...
        attribute_metadata (DataspaceResourceFileAttributeResponseAttributeMetadataType0 | None | Unset):
    ...
    attribute_metadata: DataspaceResourceFileAttributeResponseAttributeMetadataType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.attribute_metadata, DataspaceResourceFileAttributeResponseAttributeMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_attribute_metadata(
            data: object,
        ) -> DataspaceResourceFileAttributeResponseAttributeMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                attribute_metadata_type_0 = DataspaceResourceFileAttributeResponseAttributeMetadataType0.from_dict(data)

                return attribute_metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DataspaceResourceFileAttributeResponseAttributeMetadataType0 | None | Unset, data)
        ...
        dataspace_resource_file_attribute_response = cls(
            created_by=created_by,
            updated_by=updated_by,
            attribute_name=attribute_name,
            attribute_type=attribute_type,
        ...
        dataspace_resource_file_attribute_response.additional_properties = d
        return dataspace_resource_file_attribute_response
