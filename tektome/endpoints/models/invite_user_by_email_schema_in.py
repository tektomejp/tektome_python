...
T = TypeVar("T", bound="InviteUserByEmailSchemaIn")


@_attrs_define
class InviteUserByEmailSchemaIn:
    """
    Attributes:
        email (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invite_user_by_email_schema_in = cls(
            email=email,
            role_name=role_name,
        )

        invite_user_by_email_schema_in.additional_properties = d
        return invite_user_by_email_schema_in
