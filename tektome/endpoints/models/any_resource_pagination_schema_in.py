...
T = TypeVar("T", bound="AnyResourcePaginationSchemaIn")


@_attrs_define
class AnyResourcePaginationSchemaIn:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        any_resource_pagination_schema_in = cls(
            resource_id=resource_id,
            page=page,
            page_size=page_size,
        )

        any_resource_pagination_schema_in.additional_properties = d
        return any_resource_pagination_schema_in
