...
from ..models.template_filter_request_ui_trigger_kind_choices import TemplateFilterRequestUiTriggerKindChoices
from ..types import UNSET, Unset

T = TypeVar("T", bound="TemplateFilterRequest")


@_attrs_define
class TemplateFilterRequest:
    """
    Attributes:
        ui_trigger_name (None | str | Unset): Filter templates by UI trigger name.
        ui_trigger_kinds (list[TemplateFilterRequestUiTriggerKindChoices] | Unset): Filter templates by UI trigger kind.
    ...
    ui_trigger_kinds: list[TemplateFilterRequestUiTriggerKindChoices] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _ui_trigger_kinds is not UNSET:
            ...
            for ui_trigger_kinds_item_data in _ui_trigger_kinds:
                ui_trigger_kinds_item = TemplateFilterRequestUiTriggerKindChoices(ui_trigger_kinds_item_data)
        ...
        template_filter_request.additional_properties = d
        return template_filter_request
