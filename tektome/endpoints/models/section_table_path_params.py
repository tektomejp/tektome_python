...
from ..models.section_table_path_params_mode import SectionTablePathParamsMode
from ..types import UNSET, Unset

T = TypeVar("T", bound="SectionTablePathParams")


@_attrs_define
class SectionTablePathParams:
    ...
    Refers to the entire second row in the first table of the page id 1.
        ...
        Attributes:
            ...
            mode (SectionTablePathParamsMode | Unset): Mode of the table path: 'row' for entire row, 'column' for entire
                column, 'cell' for specific cell Default: SectionTablePathParamsMode.CELL.
    """
    ...
    mode: SectionTablePathParamsMode | Unset = SectionTablePathParamsMode.CELL
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mode: SectionTablePathParamsMode | Unset
        if isinstance(_mode, Unset):
            mode = UNSET
        else:
            mode = SectionTablePathParamsMode(_mode)

        section_table_path_params = cls(
            page_id=page_id,
            table_index=table_index,
            row_index=row_index,
        ...
        section_table_path_params.additional_properties = d
        return section_table_path_params
