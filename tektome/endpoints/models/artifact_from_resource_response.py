...
T = TypeVar("T", bound="ArtifactFromResourceResponse")


@_attrs_define
class ArtifactFromResourceResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        artifact_from_resource_response = cls(
            created=created,
            updated=updated,
            chatroom=chatroom,
            path=path,
        ...
        artifact_from_resource_response.additional_properties = d
        return artifact_from_resource_response
