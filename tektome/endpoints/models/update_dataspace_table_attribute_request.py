...
T = TypeVar("T", bound="UpdateDataspaceTableAttributeRequest")


@_attrs_define
class UpdateDataspaceTableAttributeRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_dataspace_table_attribute_request = cls(
            cells=cells,
            version=version,
        )

        update_dataspace_table_attribute_request.additional_properties = d
        return update_dataspace_table_attribute_request
