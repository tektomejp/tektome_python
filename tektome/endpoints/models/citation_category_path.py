...
T = TypeVar("T", bound="CitationCategoryPath")


@_attrs_define
class CitationCategoryPath:
    """
    Attributes:
        attribute_id (UUID):
        dataspace_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        citation_category_path = cls(
            attribute_id=attribute_id,
            dataspace_id=dataspace_id,
            attribute_category=attribute_category,
        )

        citation_category_path.additional_properties = d
        return citation_category_path
