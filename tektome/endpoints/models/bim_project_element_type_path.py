...
T = TypeVar("T", bound="BimProjectElementTypePath")


@_attrs_define
class BimProjectElementTypePath:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bim_project_element_type_path = cls(
            bim_project_id=bim_project_id,
            bim_type=bim_type,
        )

        bim_project_element_type_path.additional_properties = d
        return bim_project_element_type_path
