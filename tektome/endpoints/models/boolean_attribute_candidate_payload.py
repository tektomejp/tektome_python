...
T = TypeVar("T", bound="BooleanAttributeCandidatePayload")


@_attrs_define
class BooleanAttributeCandidatePayload:
    """
    Attributes:
        ...
        value (bool | None | Unset): The boolean attribute value.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        boolean_attribute_candidate_payload = cls(
        ...
        boolean_attribute_candidate_payload.additional_properties = d
        return boolean_attribute_candidate_payload
