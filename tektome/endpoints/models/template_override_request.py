...
T = TypeVar("T", bound="TemplateOverrideRequest")


@_attrs_define
class TemplateOverrideRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        template_override_request.additional_properties = d
        return template_override_request
