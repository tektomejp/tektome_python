...
if TYPE_CHECKING:
    from ..models.table_attribute_schema_response_value_type_0 import TableAttributeSchemaResponseValueType0


T = TypeVar("T", bound="TableAttributeSchemaResponse")


@_attrs_define
class TableAttributeSchemaResponse:
    """
    Attributes:
        created (datetime.datetime):
        updated (datetime.datetime):
        name (str):
        attribute_type (Literal['table_attributes'] | Unset):  Default: 'table_attributes'.
        id (None | Unset | UUID):
        ...
        value (None | TableAttributeSchemaResponseValueType0 | Unset):
    """

    created: datetime.datetime
    updated: datetime.datetime
    name: str
    attribute_type: Literal["table_attributes"] | Unset = "table_attributes"
    ...
    value: None | TableAttributeSchemaResponseValueType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, TableAttributeSchemaResponseValueType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attribute_type = cast(Literal["table_attributes"] | Unset, d.pop("attribute_type", UNSET))
        if attribute_type != "table_attributes" and not isinstance(attribute_type, Unset):
            raise ValueError(f"attribute_type must match const 'table_attributes', got '{attribute_type}'")
        ...
        def _parse_value(data: object) -> None | TableAttributeSchemaResponseValueType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = TableAttributeSchemaResponseValueType0.from_dict(data)

                return value_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | TableAttributeSchemaResponseValueType0 | Unset, data)

        value = _parse_value(d.pop("value", UNSET))

        table_attribute_schema_response = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        table_attribute_schema_response.additional_properties = d
        return table_attribute_schema_response
