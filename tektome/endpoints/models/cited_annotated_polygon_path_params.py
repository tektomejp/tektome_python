...
T = TypeVar("T", bound="CitedAnnotatedPolygonPathParams")


@_attrs_define
class CitedAnnotatedPolygonPathParams:
    """
    Attributes:
        attribute_id (UUID):
        dataspace_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cited_annotated_polygon_path_params = cls(
            attribute_id=attribute_id,
            dataspace_id=dataspace_id,
            attribute_category=attribute_category,
            polygon_annotation_id=polygon_annotation_id,
        ...
        cited_annotated_polygon_path_params.additional_properties = d
        return cited_annotated_polygon_path_params
