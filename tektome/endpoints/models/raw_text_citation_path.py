...
T = TypeVar("T", bound="RawTextCitationPath")


@_attrs_define
class RawTextCitationPath:
    """
    Attributes:
        attribute_id (UUID):
        dataspace_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        raw_text_citation_path = cls(
            attribute_id=attribute_id,
            dataspace_id=dataspace_id,
            rawtext_citation_id=rawtext_citation_id,
        )

        raw_text_citation_path.additional_properties = d
        return raw_text_citation_path
