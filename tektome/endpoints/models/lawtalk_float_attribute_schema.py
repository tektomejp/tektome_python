...
T = TypeVar("T", bound="LawtalkFloatAttributeSchema")


@_attrs_define
class LawtalkFloatAttributeSchema:
    """
    Attributes:
        name (str):
        value (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_float_attribute_schema = cls(
            name=name,
            value=value,
            operator=operator,
        )

        lawtalk_float_attribute_schema.additional_properties = d
        return lawtalk_float_attribute_schema
