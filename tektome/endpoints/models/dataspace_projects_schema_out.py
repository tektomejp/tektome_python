...
T = TypeVar("T", bound="DataspaceProjectsSchemaOut")


@_attrs_define
class DataspaceProjectsSchemaOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_projects_schema_out = cls(
            core_attributes=core_attributes,
            root_folder_id=root_folder_id,
            created_by=created_by,
            created=created,
        ...
        dataspace_projects_schema_out.additional_properties = d
        return dataspace_projects_schema_out
