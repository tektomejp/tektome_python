...
T = TypeVar("T", bound="RequirementResearchTemplatePathParams")


@_attrs_define
class RequirementResearchTemplatePathParams:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        requirement_research_template_path_params = cls(
            research_template_id=research_template_id,
            requirement_id=requirement_id,
        )

        requirement_research_template_path_params.additional_properties = d
        return requirement_research_template_path_params
