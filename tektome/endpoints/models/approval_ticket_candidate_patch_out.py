...
if TYPE_CHECKING:
    from ..models.approval_ticket_candidate_patch_out_data_container import ApprovalTicketCandidatePatchOutDataContainer
...
class ApprovalTicketCandidatePatchOut:
    ...
    Attributes:
        id (None | Unset | UUID):
        data_container (ApprovalTicketCandidatePatchOutDataContainer | Unset): The data related to this approval ticket
    ...
    data_container: ApprovalTicketCandidatePatchOutDataContainer | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.approval_ticket_candidate_patch_out_data_container import (
        ...
        data_container: ApprovalTicketCandidatePatchOutDataContainer | Unset
        if isinstance(_data_container, Unset):
            data_container = UNSET
        else:
            data_container = ApprovalTicketCandidatePatchOutDataContainer.from_dict(_data_container)
