...
if TYPE_CHECKING:
    from ..models.create_attribute_request_value_type_7 import CreateAttributeRequestValueType7
...
class CreateAttributeRequest:
    ...
    name: str
    value: bool | CreateAttributeRequestValueType7 | datetime.date | datetime.datetime | float | int | list[Any] | str
    type_: AttributeType
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.value, datetime.date):
            ...
            value = self.value.isoformat()
        elif isinstance(self.value, CreateAttributeRequestValueType7):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(
            ...
            bool | CreateAttributeRequestValueType7 | datetime.date | datetime.datetime | float | int | list[Any] | str
        ):
            try:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_7 = CreateAttributeRequestValueType7.from_dict(data)
