...
if TYPE_CHECKING:
    from ..models.coordinate_attribute_schema_out_value_type_0 import CoordinateAttributeSchemaOutValueType0


T = TypeVar("T", bound="CoordinateAttributeSchemaOut")


@_attrs_define
class CoordinateAttributeSchemaOut:
    """
    Attributes:
        ...
        value (CoordinateAttributeSchemaOutValueType0 | None | Unset):
    """
    ...
    value: CoordinateAttributeSchemaOutValueType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, CoordinateAttributeSchemaOutValueType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> CoordinateAttributeSchemaOutValueType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = CoordinateAttributeSchemaOutValueType0.from_dict(data)

                return value_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CoordinateAttributeSchemaOutValueType0 | None | Unset, data)

        value = _parse_value(d.pop("value", UNSET))

        coordinate_attribute_schema_out = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        coordinate_attribute_schema_out.additional_properties = d
        return coordinate_attribute_schema_out
