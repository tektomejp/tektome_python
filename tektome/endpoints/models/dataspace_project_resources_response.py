...
T = TypeVar("T", bound="DataspaceProjectResourcesResponse")


@_attrs_define
class DataspaceProjectResourcesResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_project_resources_response = cls(
            file=file,
            core_attributes=core_attributes,
            core_attributes_metadata=core_attributes_metadata,
            created_by=created_by,
        ...
        dataspace_project_resources_response.additional_properties = d
        return dataspace_project_resources_response
