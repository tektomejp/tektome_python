...
T = TypeVar("T", bound="SharedProjectAttributes")


@_attrs_define
class SharedProjectAttributes:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        shared_project_attributes.additional_properties = d
        return shared_project_attributes
