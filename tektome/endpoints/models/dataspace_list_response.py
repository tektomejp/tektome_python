...
T = TypeVar("T", bound="DataspaceListResponse")


@_attrs_define
class DataspaceListResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_list_response.additional_properties = d
        return dataspace_list_response
