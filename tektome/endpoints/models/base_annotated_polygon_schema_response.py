...
T = TypeVar("T", bound="BaseAnnotatedPolygonSchemaResponse")


@_attrs_define
class BaseAnnotatedPolygonSchemaResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        base_annotated_polygon_schema_response = cls(
            bounding_geometry=bounding_geometry,
            capture=capture,
            id=id,
            status=status,
        ...
        base_annotated_polygon_schema_response.additional_properties = d
        return base_annotated_polygon_schema_response
