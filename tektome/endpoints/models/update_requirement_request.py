...
T = TypeVar("T", bound="UpdateRequirementRequest")
...
class UpdateRequirementRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_requirement_request = cls(
            name=name,
            summary=summary,
            question=question,
            keywords=keywords,
        ...
        update_requirement_request.additional_properties = d
        return update_requirement_request
