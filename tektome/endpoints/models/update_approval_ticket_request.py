...
T = TypeVar("T", bound="UpdateApprovalTicketRequest")


@_attrs_define
class UpdateApprovalTicketRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_approval_ticket_request = cls(
            category=category,
            status=status,
            is_auto_select_first_candidate=is_auto_select_first_candidate,
        )

        update_approval_ticket_request.additional_properties = d
        return update_approval_ticket_request
