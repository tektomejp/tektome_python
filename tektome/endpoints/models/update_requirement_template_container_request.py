...
T = TypeVar("T", bound="UpdateRequirementTemplateContainerRequest")


@_attrs_define
class UpdateRequirementTemplateContainerRequest:
    """
    Attributes:
        name (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_requirement_template_container_request = cls(
            name=name,
        ...
        update_requirement_template_container_request.additional_properties = d
        return update_requirement_template_container_request
