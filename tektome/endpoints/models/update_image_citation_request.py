...
T = TypeVar("T", bound="UpdateImageCitationRequest")


@_attrs_define
class UpdateImageCitationRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_image_citation_request = cls(
            title=title,
            keywords=keywords,
            overlay_html=overlay_html,
        )

        update_image_citation_request.additional_properties = d
        return update_image_citation_request
