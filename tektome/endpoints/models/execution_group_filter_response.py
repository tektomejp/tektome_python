...
T = TypeVar("T", bound="ExecutionGroupFilterResponse")


@_attrs_define
class ExecutionGroupFilterResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        execution_group_filter_response = cls(
            process=process,
            process_type=process_type,
            target_files=target_files,
            target_entities=target_entities,
        ...
        execution_group_filter_response.additional_properties = d
        return execution_group_filter_response
