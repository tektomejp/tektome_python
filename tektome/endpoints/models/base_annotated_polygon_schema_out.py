...
T = TypeVar("T", bound="BaseAnnotatedPolygonSchemaOut")


@_attrs_define
class BaseAnnotatedPolygonSchemaOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        base_annotated_polygon_schema_out = cls(
            bounding_geometry=bounding_geometry,
            capture=capture,
            id=id,
            status=status,
        ...
        base_annotated_polygon_schema_out.additional_properties = d
        return base_annotated_polygon_schema_out
