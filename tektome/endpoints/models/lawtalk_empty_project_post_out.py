...
T = TypeVar("T", bound="LawtalkEmptyProjectPostOut")


@_attrs_define
class LawtalkEmptyProjectPostOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_empty_project_post_out = cls(
            core_attributes=core_attributes,
            created=created,
            updated=updated,
            id=id,
        ...
        lawtalk_empty_project_post_out.additional_properties = d
        return lawtalk_empty_project_post_out
