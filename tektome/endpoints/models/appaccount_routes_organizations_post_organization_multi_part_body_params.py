...
T = TypeVar("T", bound="AppaccountRoutesOrganizationsPostOrganizationMultiPartBodyParams")


@_attrs_define
class AppaccountRoutesOrganizationsPostOrganizationMultiPartBodyParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appaccount_routes_organizations_post_organization_multi_part_body_params = cls(
            payload=payload,
            logo_file=logo_file,
        )

        appaccount_routes_organizations_post_organization_multi_part_body_params.additional_properties = d
        return appaccount_routes_organizations_post_organization_multi_part_body_params
