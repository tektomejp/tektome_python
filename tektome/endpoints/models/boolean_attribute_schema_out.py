...
T = TypeVar("T", bound="BooleanAttributeSchemaOut")


@_attrs_define
class BooleanAttributeSchemaOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        boolean_attribute_schema_out = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        boolean_attribute_schema_out.additional_properties = d
        return boolean_attribute_schema_out
