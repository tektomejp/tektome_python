...
if TYPE_CHECKING:
    from ..models.single_select_attribute_schema_out_value_type_0 import SingleSelectAttributeSchemaOutValueType0


T = TypeVar("T", bound="SingleSelectAttributeSchemaOut")


@_attrs_define
class SingleSelectAttributeSchemaOut:
    """
    Attributes:
        ...
        value (None | SingleSelectAttributeSchemaOutValueType0 | Unset):
    """
    ...
    value: None | SingleSelectAttributeSchemaOutValueType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, SingleSelectAttributeSchemaOutValueType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> None | SingleSelectAttributeSchemaOutValueType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = SingleSelectAttributeSchemaOutValueType0.from_dict(data)

                return value_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SingleSelectAttributeSchemaOutValueType0 | Unset, data)

        value = _parse_value(d.pop("value", UNSET))

        single_select_attribute_schema_out = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        single_select_attribute_schema_out.additional_properties = d
        return single_select_attribute_schema_out
