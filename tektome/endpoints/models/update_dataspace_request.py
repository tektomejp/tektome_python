...
T = TypeVar("T", bound="UpdateDataspaceRequest")


@_attrs_define
class UpdateDataspaceRequest:
    """
    Attributes:
        name (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_dataspace_request.additional_properties = d
        return update_dataspace_request
