...
T = TypeVar("T", bound="LawtalkProjectSchemaGetOut")


@_attrs_define
class LawtalkProjectSchemaGetOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_project_schema_get_out = cls(
            lawtalk_attributes=lawtalk_attributes,
            core_attributes=core_attributes,
            core_project_id=core_project_id,
            organization=organization,
        ...
        lawtalk_project_schema_get_out.additional_properties = d
        return lawtalk_project_schema_get_out
