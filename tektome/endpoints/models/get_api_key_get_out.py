...
T = TypeVar("T", bound="GetAPIKeyGetOut")


@_attrs_define
class GetAPIKeyGetOut:
    """Schema for retrieving API key details.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_api_key_get_out.additional_properties = d
        return get_api_key_get_out
