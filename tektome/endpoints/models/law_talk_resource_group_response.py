...
T = TypeVar("T", bound="LawTalkResourceGroupResponse")


@_attrs_define
class LawTalkResourceGroupResponse:
    """Resource Group POST schema
    ...
    Attributes:
        ...
        id (None | Unset | UUID):
        resources (list[LawtalkResourceSchema] | Unset):
    """
    ...
    resources: list[LawtalkResourceSchema] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _resources is not UNSET:
            ...
            for resources_item_data in _resources:
                resources_item = LawtalkResourceSchema.from_dict(resources_item_data)

                resources.append(resources_item)

        law_talk_resource_group_response = cls(
            lawtalk_attributes=lawtalk_attributes,
            core_attributes=core_attributes,
            file_count=file_count,
            root_folder=root_folder,
        ...
        law_talk_resource_group_response.additional_properties = d
        return law_talk_resource_group_response
