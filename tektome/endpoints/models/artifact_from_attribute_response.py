...
T = TypeVar("T", bound="ArtifactFromAttributeResponse")


@_attrs_define
class ArtifactFromAttributeResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        artifact_from_attribute_response = cls(
            created=created,
            updated=updated,
            chatroom=chatroom,
            path=path,
        ...
        artifact_from_attribute_response.additional_properties = d
        return artifact_from_attribute_response
