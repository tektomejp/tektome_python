...
class DataspaceGetOut:
    ...
    Attributes:
        ...
        icon (None | str | Unset):
        core_project_attr_config (list[DataspaceProjectAttributeResponse] | Unset):
        core_resource_file_attr_config (list[DataspaceResourceFileAttributeResponse] | Unset):
    """
    ...
    core_project_attr_config: list[DataspaceProjectAttributeResponse] | Unset = UNSET
    core_resource_file_attr_config: list[DataspaceResourceFileAttributeResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _core_project_attr_config is not UNSET:
            ...
            for core_project_attr_config_item_data in _core_project_attr_config:
                core_project_attr_config_item = DataspaceProjectAttributeResponse.from_dict(
        ...
        if _core_resource_file_attr_config is not UNSET:
            ...
            for core_resource_file_attr_config_item_data in _core_resource_file_attr_config:
                core_resource_file_attr_config_item = DataspaceResourceFileAttributeResponse.from_dict(
