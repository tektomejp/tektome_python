...
if TYPE_CHECKING:
    from ..models.create_notification_testing_request_extras import CreateNotificationTestingRequestExtras


T = TypeVar("T", bound="CreateNotificationTestingRequest")


@_attrs_define
class CreateNotificationTestingRequest:
    ...
    Attributes:
        ...
        extras (CreateNotificationTestingRequestExtras | Unset): Additional keyword arguments for content template
            formatting.
    """
    ...
    extras: CreateNotificationTestingRequestExtras | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        extras: CreateNotificationTestingRequestExtras | Unset
        if isinstance(_extras, Unset):
            extras = UNSET
        else:
            extras = CreateNotificationTestingRequestExtras.from_dict(_extras)

        create_notification_testing_request = cls(
            notification_type=notification_type,
            entity_type=entity_type,
            dataspace_id=dataspace_id,
            entity_id=entity_id,
        ...
        create_notification_testing_request.additional_properties = d
        return create_notification_testing_request
