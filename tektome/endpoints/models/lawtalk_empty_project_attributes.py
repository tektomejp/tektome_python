...
T = TypeVar("T", bound="LawtalkEmptyProjectAttributes")


@_attrs_define
class LawtalkEmptyProjectAttributes:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_empty_project_attributes = cls(
            name=name,
        ...
        lawtalk_empty_project_attributes.additional_properties = d
        return lawtalk_empty_project_attributes
