...
T = TypeVar("T", bound="ReplaceDefaultAttributeBodyRequest")


@_attrs_define
class ReplaceDefaultAttributeBodyRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        replace_default_attribute_body_request = cls(
        ...
        replace_default_attribute_body_request.additional_properties = d
        return replace_default_attribute_body_request
