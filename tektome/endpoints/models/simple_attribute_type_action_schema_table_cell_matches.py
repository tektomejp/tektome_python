...
T = TypeVar("T", bound="SimpleAttributeTypeActionSchemaTableCellMatches")


@_attrs_define
class SimpleAttributeTypeActionSchemaTableCellMatches:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        action = cast(Literal["cell_matches"], d.pop("action"))
        ...
        simple_attribute_type_action_schema_table_cell_matches.additional_properties = d
        return simple_attribute_type_action_schema_table_cell_matches
