...
T = TypeVar("T", bound="LawtalkResourceChildren")


@_attrs_define
class LawtalkResourceChildren:
    """
    Attributes:
        file (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_resource_children.additional_properties = d
        return lawtalk_resource_children
