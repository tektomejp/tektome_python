...
T = TypeVar("T", bound="DataspaceSearchFilterConfigurationInPatch")


@_attrs_define
class DataspaceSearchFilterConfigurationInPatch:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_search_filter_configuration_in_patch = cls(
            name=name,
        ...
        dataspace_search_filter_configuration_in_patch.additional_properties = d
        return dataspace_search_filter_configuration_in_patch
