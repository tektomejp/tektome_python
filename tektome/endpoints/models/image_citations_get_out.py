...
T = TypeVar("T", bound="ImageCitationsGetOut")


@_attrs_define
class ImageCitationsGetOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_citations_get_out.additional_properties = d
        return image_citations_get_out
