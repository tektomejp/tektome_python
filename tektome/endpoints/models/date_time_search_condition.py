...
T = TypeVar("T", bound="DateTimeSearchCondition")


@_attrs_define
class DateTimeSearchCondition:
    """Data Model for datetime conditions. Expect attribute_type to be "datetime"

    Attributes:
        attribute_name (str): The name of the attribute to filter on
        attribute_type (Literal['datetime']): The type of the attribute being filtered (datetime)
        ...
        value (datetime.datetime): The value to filter by
    """

    attribute_name: str
    attribute_type: Literal["datetime"]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attribute_type = cast(Literal["datetime"], d.pop("attribute_type"))
        if attribute_type != "datetime":
            raise ValueError(f"attribute_type must match const 'datetime', got '{attribute_type}'")

        action = DateTimeConditionAction(d.pop("action"))

        value = isoparse(d.pop("value"))

        date_time_search_condition = cls(
            attribute_name=attribute_name,
            attribute_type=attribute_type,
            action=action,
            value=value,
        ...
        date_time_search_condition.additional_properties = d
        return date_time_search_condition
