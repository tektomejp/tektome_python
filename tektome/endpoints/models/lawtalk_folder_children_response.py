...
T = TypeVar("T", bound="LawtalkFolderChildrenResponse")


@_attrs_define
class LawtalkFolderChildrenResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_folder_children_response = cls(
            core_attributes=core_attributes,
            resources=resources,
            folders=folders,
            count=count,
        ...
        lawtalk_folder_children_response.additional_properties = d
        return lawtalk_folder_children_response
