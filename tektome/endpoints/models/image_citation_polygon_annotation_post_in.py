...
T = TypeVar("T", bound="ImageCitationPolygonAnnotationPostIn")


@_attrs_define
class ImageCitationPolygonAnnotationPostIn:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_citation_polygon_annotation_post_in = cls(
            attribute_type=attribute_type,
            bounding_geometry=bounding_geometry,
        )

        image_citation_polygon_annotation_post_in.additional_properties = d
        return image_citation_polygon_annotation_post_in
