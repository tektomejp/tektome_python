...
T = TypeVar("T", bound="GenBreadcrumbsResponse")


@_attrs_define
class GenBreadcrumbsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gen_breadcrumbs_response = cls(
            project=project,
            parents=parents,
        )

        gen_breadcrumbs_response.additional_properties = d
        return gen_breadcrumbs_response
