...
T = TypeVar("T", bound="AffectedRequirementResponse")


@_attrs_define
class AffectedRequirementResponse:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        affected_requirement_response = cls(
            name=name,
            created=created,
            updated=updated,
            id=id,
        ...
        affected_requirement_response.additional_properties = d
        return affected_requirement_response
