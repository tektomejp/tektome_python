...
if TYPE_CHECKING:
    ...
    from ..models.folder_level_children import FolderLevelChildren
    from ..models.folder_required_schema import FolderRequiredSchema


T = TypeVar("T", bound="FolderGetOut")


@_attrs_define
class FolderGetOut:
    """Schema for getting a folder with its resources and children.

    Attributes:
        core_attributes (FolderRequiredSchema): Folder required schema
        is_root (bool):
        resources (list[AppresourceResourceSchema]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = AppresourceResourceSchema.from_dict(resources_item_data)
        ...
        for children_item_data in _children:
            children_item = FolderLevelChildren.from_dict(children_item_data)
        ...
        folder_get_out.additional_properties = d
        return folder_get_out
