...
T = TypeVar("T", bound="DateAttributeSchemaResponse")


@_attrs_define
class DateAttributeSchemaResponse:
    """
    Attributes:
        created (datetime.datetime):
        updated (datetime.datetime):
        name (str):
        attribute_type (Literal['date_attributes'] | Unset):  Default: 'date_attributes'.
        id (None | Unset | UUID):
    ...
    updated: datetime.datetime
    name: str
    attribute_type: Literal["date_attributes"] | Unset = "date_attributes"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attribute_type = cast(Literal["date_attributes"] | Unset, d.pop("attribute_type", UNSET))
        if attribute_type != "date_attributes" and not isinstance(attribute_type, Unset):
            raise ValueError(f"attribute_type must match const 'date_attributes', got '{attribute_type}'")
        ...
        date_attribute_schema_response = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        date_attribute_schema_response.additional_properties = d
        return date_attribute_schema_response
