...
@_attrs_define
class CreateDeepResearchChatRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_deep_research_chat_request = cls(
            prompt=prompt,
            recipe=recipe,
            requirement_id=requirement_id,
            model=model,
        ...
        create_deep_research_chat_request.additional_properties = d
        return create_deep_research_chat_request
