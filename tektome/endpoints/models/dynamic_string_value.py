...
T = TypeVar("T", bound="DynamicStringValue")


@_attrs_define
class DynamicStringValue:
    """Dynamic value for string attributes.
    ...
    Attributes:
        ...
        attribute_type (Literal['string']): The type of the attribute to filter on
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dynamic_string_value.additional_properties = d
        return dynamic_string_value
