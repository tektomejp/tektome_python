...
T = TypeVar("T", bound="ExecutionApprovalsResponse")


@_attrs_define
class ExecutionApprovalsResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        execution_approvals_response = cls(
            created_by=created_by,
            updated_by=updated_by,
            approval_candidates=approval_candidates,
            process_details=process_details,
        ...
        execution_approvals_response.additional_properties = d
        return execution_approvals_response
