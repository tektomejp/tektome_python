...
T = TypeVar("T", bound="BimQueryToKeysValuesIn")


@_attrs_define
class BimQueryToKeysValuesIn:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bim_query_to_keys_values_in = cls(
            query=query,
        )

        bim_query_to_keys_values_in.additional_properties = d
        return bim_query_to_keys_values_in
