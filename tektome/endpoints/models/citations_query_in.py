...
from ..models.citations_query_in_order_by import CitationsQueryInOrderBy
from ..models.citations_sort_keys import CitationsSortKeys
from ..types import UNSET, Unset

T = TypeVar("T", bound="CitationsQueryIn")


@_attrs_define
class CitationsQueryIn:
    """
    Attributes:
        sort_by (CitationsSortKeys | None | Unset):
        order_by (CitationsQueryInOrderBy | Unset):  Default: CitationsQueryInOrderBy.DESC.
    """

    sort_by: CitationsSortKeys | None | Unset = UNSET
    order_by: CitationsQueryInOrderBy | Unset = CitationsQueryInOrderBy.DESC
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        order_by: CitationsQueryInOrderBy | Unset
        if isinstance(_order_by, Unset):
            order_by = UNSET
        else:
            order_by = CitationsQueryInOrderBy(_order_by)

        citations_query_in = cls(
            sort_by=sort_by,
            order_by=order_by,
        )

        citations_query_in.additional_properties = d
        return citations_query_in
