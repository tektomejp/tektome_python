...
T = TypeVar("T", bound="BimQueryToKeysValuesOut")


@_attrs_define
class BimQueryToKeysValuesOut:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bim_query_to_keys_values_out = cls(
            error=error,
            keys=keys,
            values=values,
        )

        bim_query_to_keys_values_out.additional_properties = d
        return bim_query_to_keys_values_out
