...
@_attrs_define
class UploadDataspaceProjectFileMultiPartBodyParams:
    """
    Attributes:
        file (File):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        upload_dataspace_project_file_multi_part_body_params.additional_properties = d
        return upload_dataspace_project_file_multi_part_body_params
