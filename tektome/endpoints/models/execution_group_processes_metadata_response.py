...
if TYPE_CHECKING:
    from ..models.execute_process_payload_response import ExecuteProcessPayloadResponse


T = TypeVar("T", bound="ExecutionGroupProcessesMetadataResponse")


@_attrs_define
class ExecutionGroupProcessesMetadataResponse:
    """Serializer for ExecutionGroup metadata details

    Attributes:
        processes (list[ExecuteProcessPayloadResponse]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for processes_item_data in _processes:
            processes_item = ExecuteProcessPayloadResponse.from_dict(processes_item_data)
        ...
        process_count = d.pop("process_count")
        ...
        execution_group_processes_metadata_response = cls(
            processes=processes,
            created=created,
            updated=updated,
            process_count=process_count,
        ...
        execution_group_processes_metadata_response.additional_properties = d
        return execution_group_processes_metadata_response
