...
T = TypeVar("T", bound="EntityTrackerDataIn")


@_attrs_define
class EntityTrackerDataIn:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_tracker_data_in = cls(
            observed_entity=observed_entity,
            scoping_entity=scoping_entity,
            view_mode=view_mode,
        )

        entity_tracker_data_in.additional_properties = d
        return entity_tracker_data_in
