...
T = TypeVar("T", bound="BooleanSearchCondition")


@_attrs_define
class BooleanSearchCondition:
    """Data Model for boolean conditions. Expect attribute_type to be "boolean"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        boolean_search_condition.additional_properties = d
        return boolean_search_condition
