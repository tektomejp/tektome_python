...
T = TypeVar("T", bound="LawtalkBoolAttributeSchema")


@_attrs_define
class LawtalkBoolAttributeSchema:
    """
    Attributes:
        name (str):
        value (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_bool_attribute_schema = cls(
            name=name,
            value=value,
            operator=operator,
        )

        lawtalk_bool_attribute_schema.additional_properties = d
        return lawtalk_bool_attribute_schema
