...
T = TypeVar("T", bound="BulkUserInvitationSchemaResponse")


@_attrs_define
class BulkUserInvitationSchemaResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_user_invitation_schema_response = cls(
            added=added,
            skipped=skipped,
        )

        bulk_user_invitation_schema_response.additional_properties = d
        return bulk_user_invitation_schema_response
