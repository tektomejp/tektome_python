...
T = TypeVar("T", bound="PDFCitationPathParams")


@_attrs_define
class PDFCitationPathParams:
    """
    Attributes:
        attribute_id (UUID):
        dataspace_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pdf_citation_path_params.additional_properties = d
        return pdf_citation_path_params
