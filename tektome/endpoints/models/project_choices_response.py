...
T = TypeVar("T", bound="ProjectChoicesResponse")


@_attrs_define
class ProjectChoicesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_choices_response = cls(
            building_types=building_types,
            structures=structures,
        )

        project_choices_response.additional_properties = d
        return project_choices_response
