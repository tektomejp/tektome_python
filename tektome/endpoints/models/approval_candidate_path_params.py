...
T = TypeVar("T", bound="ApprovalCandidatePathParams")


@_attrs_define
class ApprovalCandidatePathParams:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        approval_candidate_path_params.additional_properties = d
        return approval_candidate_path_params
