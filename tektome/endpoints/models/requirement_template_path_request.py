...
T = TypeVar("T", bound="RequirementTemplatePathRequest")


@_attrs_define
class RequirementTemplatePathRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        requirement_template_path_request = cls(
            requirement_template_id=requirement_template_id,
        )

        requirement_template_path_request.additional_properties = d
        return requirement_template_path_request
