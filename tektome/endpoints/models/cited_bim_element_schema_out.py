...
T = TypeVar("T", bound="CitedBIMElementSchemaOut")


@_attrs_define
class CitedBIMElementSchemaOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cited_bim_element_schema_out = cls(
            bim_project=bim_project,
            id=id,
            bim_object=bim_object,
        )

        cited_bim_element_schema_out.additional_properties = d
        return cited_bim_element_schema_out
