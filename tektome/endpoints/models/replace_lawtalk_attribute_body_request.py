...
T = TypeVar("T", bound="ReplaceLawtalkAttributeBodyRequest")


@_attrs_define
class ReplaceLawtalkAttributeBodyRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        replace_lawtalk_attribute_body_request = cls(
        ...
        replace_lawtalk_attribute_body_request.additional_properties = d
        return replace_lawtalk_attribute_body_request
