...
T = TypeVar("T", bound="LawtalkDatetimeAttributeSchema")


@_attrs_define
class LawtalkDatetimeAttributeSchema:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_datetime_attribute_schema = cls(
            name=name,
            value=value,
            operator=operator,
        )

        lawtalk_datetime_attribute_schema.additional_properties = d
        return lawtalk_datetime_attribute_schema
