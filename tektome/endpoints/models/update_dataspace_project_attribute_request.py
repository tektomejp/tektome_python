...
if TYPE_CHECKING:
    from ..models.update_dataspace_project_attribute_request_attribute_metadata_type_0 import (
        UpdateDataspaceProjectAttributeRequestAttributeMetadataType0,
    )
    from ..models.update_dataspace_project_attribute_request_table_attribute_config_type_0 import (
        UpdateDataspaceProjectAttributeRequestTableAttributeConfigType0,
    )


T = TypeVar("T", bound="UpdateDataspaceProjectAttributeRequest")


@_attrs_define
class UpdateDataspaceProjectAttributeRequest:
    """
    Attributes:
        ...
        attribute_metadata (None | Unset | UpdateDataspaceProjectAttributeRequestAttributeMetadataType0):
        table_attribute_config (None | Unset | UpdateDataspaceProjectAttributeRequestTableAttributeConfigType0):
    """
    ...
    attribute_metadata: None | Unset | UpdateDataspaceProjectAttributeRequestAttributeMetadataType0 = UNSET
    table_attribute_config: None | Unset | UpdateDataspaceProjectAttributeRequestTableAttributeConfigType0 = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.attribute_metadata, UpdateDataspaceProjectAttributeRequestAttributeMetadataType0):
        ...
        elif isinstance(self.table_attribute_config, UpdateDataspaceProjectAttributeRequestTableAttributeConfigType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_attribute_metadata(
            data: object,
        ) -> None | Unset | UpdateDataspaceProjectAttributeRequestAttributeMetadataType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                attribute_metadata_type_0 = UpdateDataspaceProjectAttributeRequestAttributeMetadataType0.from_dict(data)

                return attribute_metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UpdateDataspaceProjectAttributeRequestAttributeMetadataType0, data)

        attribute_metadata = _parse_attribute_metadata(d.pop("attribute_metadata", UNSET))

        def _parse_table_attribute_config(
            data: object,
        ) -> None | Unset | UpdateDataspaceProjectAttributeRequestTableAttributeConfigType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                table_attribute_config_type_0 = (
                    UpdateDataspaceProjectAttributeRequestTableAttributeConfigType0.from_dict(data)
                )

                return table_attribute_config_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UpdateDataspaceProjectAttributeRequestTableAttributeConfigType0, data)

        table_attribute_config = _parse_table_attribute_config(d.pop("table_attribute_config", UNSET))

        update_dataspace_project_attribute_request = cls(
        ...
        update_dataspace_project_attribute_request.additional_properties = d
        return update_dataspace_project_attribute_request
