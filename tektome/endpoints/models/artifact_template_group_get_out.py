...
T = TypeVar("T", bound="ArtifactTemplateGroupGetOut")


@_attrs_define
class ArtifactTemplateGroupGetOut:
    """
    Attributes:
        template_count (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        artifact_template_group_get_out = cls(
            template_count=template_count,
            name=name,
            kind=kind,
            created=created,
        ...
        artifact_template_group_get_out.additional_properties = d
        return artifact_template_group_get_out
