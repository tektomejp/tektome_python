...
T = TypeVar("T", bound="DateTimeAttributeSchemaResponse")


@_attrs_define
class DateTimeAttributeSchemaResponse:
    """
    Attributes:
        ...
        value (datetime.datetime | None | Unset):
    """
    ...
    value: datetime.datetime | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> datetime.datetime | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        date_time_attribute_schema_response = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        date_time_attribute_schema_response.additional_properties = d
        return date_time_attribute_schema_response
