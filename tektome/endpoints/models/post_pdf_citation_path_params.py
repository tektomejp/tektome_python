...
T = TypeVar("T", bound="PostPDFCitationPathParams")


@_attrs_define
class PostPDFCitationPathParams:
    """
    Attributes:
        attribute_id (UUID):
        dataspace_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_pdf_citation_path_params = cls(
            attribute_id=attribute_id,
            dataspace_id=dataspace_id,
            attribute_category=attribute_category,
            pdf_citation_id=pdf_citation_id,
        ...
        post_pdf_citation_path_params.additional_properties = d
        return post_pdf_citation_path_params
