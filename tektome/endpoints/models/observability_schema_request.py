...
T = TypeVar("T", bound="ObservabilitySchemaRequest")


@_attrs_define
class ObservabilitySchemaRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        observability_schema_request = cls(
            observed_entity=observed_entity,
            scoping_entity=scoping_entity,
            is_viewed=is_viewed,
        )

        observability_schema_request.additional_properties = d
        return observability_schema_request
