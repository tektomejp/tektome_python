...
if TYPE_CHECKING:
    ...
    from ..models.process_response_input_schema_patch_type_0 import ProcessResponseInputSchemaPatchType0
    from ..models.process_response_openflow_json import ProcessResponseOpenflowJson
...
class ProcessResponse:
    ...
    Attributes:
        ...
        name (str):
        organization (UUID):
        project_attributes (list[DataspaceProjectAttributeResponse] | Unset):
        resource_attributes (list[DataspaceResourceFileAttributeResponse] | Unset):
        id (None | Unset | UUID):
        description (None | str | Unset):  Default: ''.
        openflow_json (ProcessResponseOpenflowJson | Unset):
        ...
        input_schema_patch (None | ProcessResponseInputSchemaPatchType0 | Unset):
    """
    ...
    name: str
    organization: UUID
    project_attributes: list[DataspaceProjectAttributeResponse] | Unset = UNSET
    resource_attributes: list[DataspaceResourceFileAttributeResponse] | Unset = UNSET
    id: None | Unset | UUID = UNSET
    description: None | str | Unset = ""
    openflow_json: ProcessResponseOpenflowJson | Unset = UNSET
    ...
    input_schema_patch: None | ProcessResponseInputSchemaPatchType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.input_schema_patch, ProcessResponseInputSchemaPatchType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _project_attributes is not UNSET:
            ...
            for project_attributes_item_data in _project_attributes:
                project_attributes_item = DataspaceProjectAttributeResponse.from_dict(project_attributes_item_data)
        ...
        if _resource_attributes is not UNSET:
            ...
            for resource_attributes_item_data in _resource_attributes:
                resource_attributes_item = DataspaceResourceFileAttributeResponse.from_dict(
        ...
        if isinstance(_openflow_json, Unset):
            ...
            openflow_json = ProcessResponseOpenflowJson.from_dict(_openflow_json)
        ...
        def _parse_input_schema_patch(data: object) -> None | ProcessResponseInputSchemaPatchType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                input_schema_patch_type_0 = ProcessResponseInputSchemaPatchType0.from_dict(data)

                return input_schema_patch_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ProcessResponseInputSchemaPatchType0 | Unset, data)
