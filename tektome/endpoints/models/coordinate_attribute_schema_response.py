...
if TYPE_CHECKING:
    from ..models.coordinate_attribute_schema_response_value_type_0 import CoordinateAttributeSchemaResponseValueType0


T = TypeVar("T", bound="CoordinateAttributeSchemaResponse")


@_attrs_define
class CoordinateAttributeSchemaResponse:
    """
    Attributes:
        created (datetime.datetime):
        updated (datetime.datetime):
        name (str):
        attribute_type (Literal['coordinate_attributes'] | Unset):  Default: 'coordinate_attributes'.
        id (None | Unset | UUID):
        ...
        value (CoordinateAttributeSchemaResponseValueType0 | None | Unset):
    """

    created: datetime.datetime
    updated: datetime.datetime
    name: str
    attribute_type: Literal["coordinate_attributes"] | Unset = "coordinate_attributes"
    ...
    value: CoordinateAttributeSchemaResponseValueType0 | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.coordinate_attribute_schema_response_value_type_0 import (
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, CoordinateAttributeSchemaResponseValueType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attribute_type = cast(Literal["coordinate_attributes"] | Unset, d.pop("attribute_type", UNSET))
        if attribute_type != "coordinate_attributes" and not isinstance(attribute_type, Unset):
            raise ValueError(f"attribute_type must match const 'coordinate_attributes', got '{attribute_type}'")
        ...
        def _parse_value(data: object) -> CoordinateAttributeSchemaResponseValueType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = CoordinateAttributeSchemaResponseValueType0.from_dict(data)

                return value_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CoordinateAttributeSchemaResponseValueType0 | None | Unset, data)

        value = _parse_value(d.pop("value", UNSET))

        coordinate_attribute_schema_response = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        coordinate_attribute_schema_response.additional_properties = d
        return coordinate_attribute_schema_response
