...
T = TypeVar("T", bound="BimViewObjectLinkResponse")


@_attrs_define
class BimViewObjectLinkResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bim_view_object_link_response = cls(
            process_ids=process_ids,
        )

        bim_view_object_link_response.additional_properties = d
        return bim_view_object_link_response
