...
if TYPE_CHECKING:
    from ..models.dataspace_resource_file_attribute_schema_response_attribute_metadata_type_0 import (
        DataspaceResourceFileAttributeSchemaResponseAttributeMetadataType0,
    )
    from ..models.user_metadata import UserMetadata


T = TypeVar("T", bound="DataspaceResourceFileAttributeSchemaResponse")


@_attrs_define
class DataspaceResourceFileAttributeSchemaResponse:
    ...
    Attributes:
        ...
        attribute_metadata (DataspaceResourceFileAttributeSchemaResponseAttributeMetadataType0 | None | Unset):
    ...
    attribute_metadata: DataspaceResourceFileAttributeSchemaResponseAttributeMetadataType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.attribute_metadata, DataspaceResourceFileAttributeSchemaResponseAttributeMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_attribute_metadata(
            data: object,
        ) -> DataspaceResourceFileAttributeSchemaResponseAttributeMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                attribute_metadata_type_0 = (
                    DataspaceResourceFileAttributeSchemaResponseAttributeMetadataType0.from_dict(data)
                )

                return attribute_metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DataspaceResourceFileAttributeSchemaResponseAttributeMetadataType0 | None | Unset, data)
        ...
        return dataspace_resource_file_attribute_schema_response
