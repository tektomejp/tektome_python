...
T = TypeVar("T", bound="DataspaceTableAttributePathParams")


@_attrs_define
class DataspaceTableAttributePathParams:
    """Path schema for table attribute endpoints. Validates the attribute is a TableAttribute.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_table_attribute_path_params = cls(
            dataspace_id=dataspace_id,
            attribute_category=attribute_category,
            attribute_id=attribute_id,
        )

        dataspace_table_attribute_path_params.additional_properties = d
        return dataspace_table_attribute_path_params
