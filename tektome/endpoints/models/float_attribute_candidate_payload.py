...
T = TypeVar("T", bound="FloatAttributeCandidatePayload")


@_attrs_define
class FloatAttributeCandidatePayload:
    """
    Attributes:
        ...
        value (float | None | Unset): The float attribute value.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        float_attribute_candidate_payload = cls(
        ...
        float_attribute_candidate_payload.additional_properties = d
        return float_attribute_candidate_payload
