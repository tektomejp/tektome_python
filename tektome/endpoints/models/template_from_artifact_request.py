...
if TYPE_CHECKING:
    from ..models.template_from_artifact_request_openflow_json_type_1 import (
        TemplateFromArtifactRequestOpenflowJsonType1,
    )


T = TypeVar("T", bound="TemplateFromArtifactRequest")


@_attrs_define
class TemplateFromArtifactRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.openflow_json, TemplateFromArtifactRequestOpenflowJsonType1):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_openflow_json(data: object) -> str | TemplateFromArtifactRequestOpenflowJsonType1:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                openflow_json_type_1 = TemplateFromArtifactRequestOpenflowJsonType1.from_dict(data)

                return openflow_json_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(str | TemplateFromArtifactRequestOpenflowJsonType1, data)
        ...
        template_from_artifact_request.additional_properties = d
        return template_from_artifact_request
