...
T = TypeVar("T", bound="CreateBimSearchDetailRequest")


@_attrs_define
class CreateBimSearchDetailRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_bim_search_detail_request = cls(
        ...
        create_bim_search_detail_request.additional_properties = d
        return create_bim_search_detail_request
