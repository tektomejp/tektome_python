...
T = TypeVar("T", bound="ImportResourceGroupRequest")


@_attrs_define
class ImportResourceGroupRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        import_resource_group_request = cls(
            resource_group_ids=resource_group_ids,
        )

        import_resource_group_request.additional_properties = d
        return import_resource_group_request
