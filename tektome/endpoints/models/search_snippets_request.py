...
T = TypeVar("T", bound="SearchSnippetsRequest")


@_attrs_define
class SearchSnippetsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_snippets_request.additional_properties = d
        return search_snippets_request
