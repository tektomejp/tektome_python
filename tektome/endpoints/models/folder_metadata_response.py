...
T = TypeVar("T", bound="FolderMetadataResponse")


@_attrs_define
class FolderMetadataResponse:
    """Schema for getting the metadata of each descendant folder.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        folder_metadata_response.additional_properties = d
        return folder_metadata_response
