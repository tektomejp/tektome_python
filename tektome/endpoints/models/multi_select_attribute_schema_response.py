...
if TYPE_CHECKING:
    from ..models.multi_select_attribute_schema_response_value_type_0 import (
        MultiSelectAttributeSchemaResponseValueType0,
    )


T = TypeVar("T", bound="MultiSelectAttributeSchemaResponse")


@_attrs_define
class MultiSelectAttributeSchemaResponse:
    """
    Attributes:
        created (datetime.datetime):
        updated (datetime.datetime):
        name (str):
        attribute_type (Literal['multi_select_attributes'] | Unset):  Default: 'multi_select_attributes'.
        id (None | Unset | UUID):
        ...
        value (MultiSelectAttributeSchemaResponseValueType0 | None | Unset):
    """

    created: datetime.datetime
    updated: datetime.datetime
    name: str
    attribute_type: Literal["multi_select_attributes"] | Unset = "multi_select_attributes"
    ...
    value: MultiSelectAttributeSchemaResponseValueType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, MultiSelectAttributeSchemaResponseValueType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attribute_type = cast(Literal["multi_select_attributes"] | Unset, d.pop("attribute_type", UNSET))
        if attribute_type != "multi_select_attributes" and not isinstance(attribute_type, Unset):
            raise ValueError(f"attribute_type must match const 'multi_select_attributes', got '{attribute_type}'")
        ...
        def _parse_value(data: object) -> MultiSelectAttributeSchemaResponseValueType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = MultiSelectAttributeSchemaResponseValueType0.from_dict(data)

                return value_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(MultiSelectAttributeSchemaResponseValueType0 | None | Unset, data)

        value = _parse_value(d.pop("value", UNSET))

        multi_select_attribute_schema_response = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        multi_select_attribute_schema_response.additional_properties = d
        return multi_select_attribute_schema_response
