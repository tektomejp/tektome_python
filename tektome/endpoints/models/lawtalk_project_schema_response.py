...
T = TypeVar("T", bound="LawtalkProjectSchemaResponse")


@_attrs_define
class LawtalkProjectSchemaResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_project_schema_response = cls(
            lawtalk_attributes=lawtalk_attributes,
            core_attributes=core_attributes,
            core_project_id=core_project_id,
            organization=organization,
        ...
        lawtalk_project_schema_response.additional_properties = d
        return lawtalk_project_schema_response
