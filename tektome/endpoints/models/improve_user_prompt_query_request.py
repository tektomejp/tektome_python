...
T = TypeVar("T", bound="ImproveUserPromptQueryRequest")


@_attrs_define
class ImproveUserPromptQueryRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        improve_user_prompt_query_request = cls(
            user_prompt=user_prompt,
            project_id=project_id,
            requirement_title=requirement_title,
            web_search_enabled=web_search_enabled,
        ...
        improve_user_prompt_query_request.additional_properties = d
        return improve_user_prompt_query_request
