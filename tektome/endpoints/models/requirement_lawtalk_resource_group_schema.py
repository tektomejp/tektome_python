...
T = TypeVar("T", bound="RequirementLawtalkResourceGroupSchema")


@_attrs_define
class RequirementLawtalkResourceGroupSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        requirement_lawtalk_resource_group_schema = cls(
            core_attributes=core_attributes,
            created=created,
            updated=updated,
            id=id,
        ...
        requirement_lawtalk_resource_group_schema.additional_properties = d
        return requirement_lawtalk_resource_group_schema
