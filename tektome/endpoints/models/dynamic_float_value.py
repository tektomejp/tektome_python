...
T = TypeVar("T", bound="DynamicFloatValue")


@_attrs_define
class DynamicFloatValue:
    """
    Attributes:
        entity (EntityType):
        ...
        attribute_type (Literal['float']): The type of the attribute to filter on
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dynamic_float_value.additional_properties = d
        return dynamic_float_value
