...
T = TypeVar("T", bound="RequirementTemplateResourcesResponse")


@_attrs_define
class RequirementTemplateResourcesResponse:
    """Serializer for Requirement Template Resources Output.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        requirement_template_resources_response = cls(
            core_attributes=core_attributes,
            lawtalk_attributes=lawtalk_attributes,
            created=created,
            updated=updated,
        ...
        requirement_template_resources_response.additional_properties = d
        return requirement_template_resources_response
