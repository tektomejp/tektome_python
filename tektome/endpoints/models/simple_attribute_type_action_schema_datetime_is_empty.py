...
T = TypeVar("T", bound="SimpleAttributeTypeActionSchemaDatetimeIsEmpty")


@_attrs_define
class SimpleAttributeTypeActionSchemaDatetimeIsEmpty:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        simple_attribute_type_action_schema_datetime_is_empty = cls(
            action=action,
            value_type=value_type,
        )

        simple_attribute_type_action_schema_datetime_is_empty.additional_properties = d
        return simple_attribute_type_action_schema_datetime_is_empty
