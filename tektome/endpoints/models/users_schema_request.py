...
T = TypeVar("T", bound="UsersSchemaRequest")


@_attrs_define
class UsersSchemaRequest:
    """Schema for getting user IDs
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_schema_request = cls(
            user_ids=user_ids,
        )

        users_schema_request.additional_properties = d
        return users_schema_request
