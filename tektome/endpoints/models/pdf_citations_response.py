...
T = TypeVar("T", bound="PDFCitationsResponse")


@_attrs_define
class PDFCitationsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pdf_citations_response.additional_properties = d
        return pdf_citations_response
