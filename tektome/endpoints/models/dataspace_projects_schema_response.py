...
T = TypeVar("T", bound="DataspaceProjectsSchemaResponse")


@_attrs_define
class DataspaceProjectsSchemaResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_projects_schema_response = cls(
            core_attributes=core_attributes,
            core_attributes_metadata=core_attributes_metadata,
            root_folder_id=root_folder_id,
            created_by=created_by,
        ...
        dataspace_projects_schema_response.additional_properties = d
        return dataspace_projects_schema_response
