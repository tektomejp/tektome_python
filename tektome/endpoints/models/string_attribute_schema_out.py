...
T = TypeVar("T", bound="StringAttributeSchemaOut")


@_attrs_define
class StringAttributeSchemaOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        string_attribute_schema_out = cls(
            created=created,
            updated=updated,
            name=name,
            id=id,
        ...
        string_attribute_schema_out.additional_properties = d
        return string_attribute_schema_out
