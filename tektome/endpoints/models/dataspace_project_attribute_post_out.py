...
if TYPE_CHECKING:
    from ..models.dataspace_project_attribute_post_out_attribute_metadata_type_0 import (
        DataspaceProjectAttributePostOutAttributeMetadataType0,
    )
    from ..models.user_metadata import UserMetadata


T = TypeVar("T", bound="DataspaceProjectAttributePostOut")


@_attrs_define
class DataspaceProjectAttributePostOut:
    """Schema for the response of posting attributes to a project in a dataspace.
    ...
    Attributes:
        ...
        attribute_metadata (DataspaceProjectAttributePostOutAttributeMetadataType0 | None | Unset):
    ...
    attribute_metadata: DataspaceProjectAttributePostOutAttributeMetadataType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.attribute_metadata, DataspaceProjectAttributePostOutAttributeMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_attribute_metadata(
            data: object,
        ) -> DataspaceProjectAttributePostOutAttributeMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                attribute_metadata_type_0 = DataspaceProjectAttributePostOutAttributeMetadataType0.from_dict(data)

                return attribute_metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DataspaceProjectAttributePostOutAttributeMetadataType0 | None | Unset, data)
        ...
        dataspace_project_attribute_post_out = cls(
            created_by=created_by,
            updated_by=updated_by,
            attribute_name=attribute_name,
            attribute_type=attribute_type,
        ...
        dataspace_project_attribute_post_out.additional_properties = d
        return dataspace_project_attribute_post_out
