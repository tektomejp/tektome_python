...
T = TypeVar("T", bound="LawtalkProjectResourceResponse")


@_attrs_define
class LawtalkProjectResourceResponse:
    """
    Attributes:
        file (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_project_resource_response = cls(
            file=file,
            lawtalk_attributes=lawtalk_attributes,
            core_attributes=core_attributes,
            created_by=created_by,
        ...
        lawtalk_project_resource_response.additional_properties = d
        return lawtalk_project_resource_response
