...
T = TypeVar("T", bound="DynamicTimeValue")


@_attrs_define
class DynamicTimeValue:
    """
    Attributes:
        entity (EntityType):
        ...
        attribute_type (Literal['time']): The type of the attribute to filter on
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dynamic_time_value.additional_properties = d
        return dynamic_time_value
