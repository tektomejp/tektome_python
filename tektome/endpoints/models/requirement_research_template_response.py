...
if TYPE_CHECKING:
    from ..models.requirement_research_template_response_project_specific_resource_groups_keywords import (
...
T = TypeVar("T", bound="RequirementResearchTemplateResponse")


@_attrs_define
class RequirementResearchTemplateResponse:
    """
    Attributes:
        ...
        project_specific_resource_groups_keywords
            (RequirementResearchTemplateResponseProjectSpecificResourceGroupsKeywords | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_project_specific_resource_groups_keywords, Unset):
            ...
            project_specific_resource_groups_keywords = (
                RequirementResearchTemplateResponseProjectSpecificResourceGroupsKeywords.from_dict(
        ...
        requirement_research_template_response = cls(
            public_resource_groups=public_resource_groups,
            created_by=created_by,
            updated_by=updated_by,
            name=name,
        ...
        requirement_research_template_response.additional_properties = d
        return requirement_research_template_response
