...
if TYPE_CHECKING:
    ...
    from ..models.requirement_resource_response import RequirementResourceResponse
    from ..models.requirement_resource_sections_schema import RequirementResourceSectionsSchema
    from ..models.requirement_response_section_changes_since_last_summary import (
        RequirementResponseSectionChangesSinceLastSummary,
    )
    from ..models.user_metadata import UserMetadata


T = TypeVar("T", bound="RequirementResponse")
...
class RequirementResponse:
    ...
    Attributes:
        ...
        resources (list[RequirementResourceResponse]):
        reference_notes (list[ReferenceNoteSchema]):
        id (None | Unset | UUID):
        section_changes_since_last_summary (RequirementResponseSectionChangesSinceLastSummary | Unset):
    """
    ...
    section_changes_since_last_summary: RequirementResponseSectionChangesSinceLastSummary | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = RequirementResourceResponse.from_dict(resources_item_data)
        ...
        if isinstance(_section_changes_since_last_summary, Unset):
            ...
            section_changes_since_last_summary = RequirementResponseSectionChangesSinceLastSummary.from_dict(
                _section_changes_since_last_summary
            )

        requirement_response = cls(
            core_attributes=core_attributes,
            created_by=created_by,
            updated_by=updated_by,
            saved_items=saved_items,
        ...
        requirement_response.additional_properties = d
