...
T = TypeVar("T", bound="GetDRDefaultOutputFormatResponse")


@_attrs_define
class GetDRDefaultOutputFormatResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_dr_default_output_format_response = cls(
            dr_default_output_format=dr_default_output_format,
        )

        get_dr_default_output_format_response.additional_properties = d
        return get_dr_default_output_format_response
