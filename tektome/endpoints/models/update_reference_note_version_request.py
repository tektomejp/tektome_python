...
@_attrs_define
class UpdateReferenceNoteVersionRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_reference_note_version_request = cls(
        ...
        update_reference_note_version_request.additional_properties = d
        return update_reference_note_version_request
