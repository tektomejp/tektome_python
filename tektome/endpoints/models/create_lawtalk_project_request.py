...
T = TypeVar("T", bound="CreateLawtalkProjectRequest")


@_attrs_define
class CreateLawtalkProjectRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_lawtalk_project_request = cls(
            attributes=attributes,
        )

        create_lawtalk_project_request.additional_properties = d
        return create_lawtalk_project_request
