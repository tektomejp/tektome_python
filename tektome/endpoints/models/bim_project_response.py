...
T = TypeVar("T", bound="BimProjectResponse")


@_attrs_define
class BimProjectResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bim_project_response.additional_properties = d
        return bim_project_response
