...
T = TypeVar("T", bound="ReplaceSectionCreationRequest")


@_attrs_define
class ReplaceSectionCreationRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        replace_section_creation_request = cls(
            project_id=project_id,
        ...
        replace_section_creation_request.additional_properties = d
        return replace_section_creation_request
