...
if TYPE_CHECKING:
    from ..models.json_attribute_schema_out_value_type_0 import JSONAttributeSchemaOutValueType0


T = TypeVar("T", bound="JSONAttributeSchemaOut")


@_attrs_define
class JSONAttributeSchemaOut:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, JSONAttributeSchemaOutValueType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> JSONAttributeSchemaOutValueType0 | None | Unset:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = JSONAttributeSchemaOutValueType0.from_dict(data)

                return value_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(JSONAttributeSchemaOutValueType0 | None | Unset, data)

        value = _parse_value(d.pop("value", UNSET))

        json_attribute_schema_out = cls(
            created=created,
            updated=updated,
            name=name,
            id=id,
        ...
        json_attribute_schema_out.additional_properties = d
        return json_attribute_schema_out
