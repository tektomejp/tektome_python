...
T = TypeVar("T", bound="PaymentRecordResponse")
...
class PaymentRecordResponse:
    ...
    Attributes:
        ...
        balance_after (str | Unset):  Default: '0'.
        balance_before (str | Unset):  Default: '0'.
    """
    ...
    balance_after: str | Unset = "0"
    balance_before: str | Unset = "0"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payment_record_response.additional_properties = d
        return payment_record_response
