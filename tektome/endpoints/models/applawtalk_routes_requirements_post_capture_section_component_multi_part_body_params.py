...
T = TypeVar("T", bound="ApplawtalkRoutesRequirementsPostCaptureSectionComponentMultiPartBodyParams")


@_attrs_define
class ApplawtalkRoutesRequirementsPostCaptureSectionComponentMultiPartBodyParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        applawtalk_routes_requirements_post_capture_section_component_multi_part_body_params = cls(
            screenshot_file=screenshot_file,
            payload=payload,
        )

        applawtalk_routes_requirements_post_capture_section_component_multi_part_body_params.additional_properties = d
        return applawtalk_routes_requirements_post_capture_section_component_multi_part_body_params
