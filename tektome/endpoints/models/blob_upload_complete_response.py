...
T = TypeVar("T", bound="BlobUploadCompleteResponse")


@_attrs_define
class BlobUploadCompleteResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        blob_upload_complete_response.additional_properties = d
        return blob_upload_complete_response
