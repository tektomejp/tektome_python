...
T = TypeVar("T", bound="AppresourceResourceSchema")


@_attrs_define
class AppresourceResourceSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appresource_resource_schema = cls(
            core_attributes=core_attributes,
            core_attributes_metadata=core_attributes_metadata,
            created=created,
            updated=updated,
        ...
        appresource_resource_schema.additional_properties = d
        return appresource_resource_schema
