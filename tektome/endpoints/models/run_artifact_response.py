...
T = TypeVar("T", bound="RunArtifactResponse")


@_attrs_define
class RunArtifactResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        run_artifact_response.additional_properties = d
        return run_artifact_response
