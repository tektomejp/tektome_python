...
T = TypeVar("T", bound="CreateAggregateLLMUsageRequest")


@_attrs_define
class CreateAggregateLLMUsageRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_aggregate_llm_usage_request = cls(
            start_date=start_date,
            end_date=end_date,
        ...
        create_aggregate_llm_usage_request.additional_properties = d
        return create_aggregate_llm_usage_request
