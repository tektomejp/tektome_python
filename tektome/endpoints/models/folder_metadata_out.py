...
T = TypeVar("T", bound="FolderMetadataOut")


@_attrs_define
class FolderMetadataOut:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        folder_metadata_out.additional_properties = d
        return folder_metadata_out
