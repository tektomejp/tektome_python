...
T = TypeVar("T", bound="SearchPayloadV5GetRequest")


@_attrs_define
class SearchPayloadV5GetRequest:
    """
    Attributes:
        query (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_payload_v5_get_request = cls(
            query=query,
            keywords=keywords,
        ...
        search_payload_v5_get_request.additional_properties = d
        return search_payload_v5_get_request
