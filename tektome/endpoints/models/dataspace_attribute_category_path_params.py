...
T = TypeVar("T", bound="DataspaceAttributeCategoryPathParams")


@_attrs_define
class DataspaceAttributeCategoryPathParams:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_attribute_category_path_params = cls(
            dataspace_id=dataspace_id,
            attribute_category=attribute_category,
        )

        dataspace_attribute_category_path_params.additional_properties = d
        return dataspace_attribute_category_path_params
