...
T = TypeVar("T", bound="EnvironmentVariableFilterRequest")


@_attrs_define
class EnvironmentVariableFilterRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        environment_variable_filter_request = cls(
            keys=keys,
        )

        environment_variable_filter_request.additional_properties = d
        return environment_variable_filter_request
