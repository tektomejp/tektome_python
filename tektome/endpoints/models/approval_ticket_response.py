...
T = TypeVar("T", bound="ApprovalTicketResponse")


@_attrs_define
class ApprovalTicketResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        approval_ticket_response.additional_properties = d
        return approval_ticket_response
