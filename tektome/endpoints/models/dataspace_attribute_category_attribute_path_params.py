...
T = TypeVar("T", bound="DataspaceAttributeCategoryAttributePathParams")


@_attrs_define
class DataspaceAttributeCategoryAttributePathParams:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_attribute_category_attribute_path_params = cls(
            dataspace_id=dataspace_id,
            attribute_category=attribute_category,
            attribute_id=attribute_id,
        )

        dataspace_attribute_category_attribute_path_params.additional_properties = d
        return dataspace_attribute_category_attribute_path_params
