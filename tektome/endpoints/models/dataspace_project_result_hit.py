...
T = TypeVar("T", bound="DataspaceProjectResultHit")


@_attrs_define
class DataspaceProjectResultHit:
    """A project hit with nested child resource hits.

    Attributes:
        id (UUID):
        score (float):
        dataspace_ids (list[UUID] | Unset):
        project_id (None | Unset | UUID):
        resource_id (None | Unset | UUID):
        string_attributes (list[EntitySearchResultHitAttribute] | Unset):
        integer_attributes (list[EntitySearchResultHitAttribute] | Unset):
        float_attributes (list[EntitySearchResultHitAttribute] | Unset):
        boolean_attributes (list[EntitySearchResultHitAttribute] | Unset):
        date_attributes (list[EntitySearchResultHitAttribute] | Unset):
        datetime_attributes (list[EntitySearchResultHitAttribute] | Unset):
        time_attributes (list[EntitySearchResultHitAttribute] | Unset):
        coordinate_attributes (list[EntitySearchResultHitAttribute] | Unset):
        polygon_attributes (list[EntitySearchResultHitAttribute] | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.created_by, Unset):
            created_by = UNSET
        elif isinstance(self.created_by, UserMetadata):
        ...
        if not isinstance(self.resource_hits, Unset):
            resource_hits = []
            for resource_hits_item_data in self.resource_hits:
                resource_hits_item = resource_hits_item_data.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_created_by(data: object) -> None | Unset | UserMetadata:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        dataspace_project_result_hit = cls(
            id=id,
            score=score,
        ...
        dataspace_project_result_hit.additional_properties = d
        return dataspace_project_result_hit
