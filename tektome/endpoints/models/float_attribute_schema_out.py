...
T = TypeVar("T", bound="FloatAttributeSchemaOut")


@_attrs_define
class FloatAttributeSchemaOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        float_attribute_schema_out = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        float_attribute_schema_out.additional_properties = d
        return float_attribute_schema_out
