...
T = TypeVar("T", bound="MarkAllReadRequest")


@_attrs_define
class MarkAllReadRequest:
    """Input schema for marking all notifications as read.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mark_all_read_request = cls(
            organization_id=organization_id,
            dataspace_id=dataspace_id,
        )

        mark_all_read_request.additional_properties = d
        return mark_all_read_request
