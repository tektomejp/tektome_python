...
if TYPE_CHECKING:
    from ..models.resource_ocr_schema_get_response_latest_task_result_type_0 import (
        ResourceOCRSchemaGetResponseLatestTaskResultType0,
    )


T = TypeVar("T", bound="ResourceOCRSchemaGetResponse")


@_attrs_define
class ResourceOCRSchemaGetResponse:
    """
    Attributes:
        ...
        latest_task_result (None | ResourceOCRSchemaGetResponseLatestTaskResultType0 | Unset):
    ...
    latest_task_result: None | ResourceOCRSchemaGetResponseLatestTaskResultType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.latest_task_result, ResourceOCRSchemaGetResponseLatestTaskResultType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_latest_task_result(data: object) -> None | ResourceOCRSchemaGetResponseLatestTaskResultType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                latest_task_result_type_0 = ResourceOCRSchemaGetResponseLatestTaskResultType0.from_dict(data)

                return latest_task_result_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ResourceOCRSchemaGetResponseLatestTaskResultType0 | Unset, data)
        ...
        resource_ocr_schema_get_response = cls(
            created=created,
            updated=updated,
            latest_submission_time=latest_submission_time,
            resource=resource,
        ...
        resource_ocr_schema_get_response.additional_properties = d
        return resource_ocr_schema_get_response
