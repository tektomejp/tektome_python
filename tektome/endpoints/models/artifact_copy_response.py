...
T = TypeVar("T", bound="ArtifactCopyResponse")


@_attrs_define
class ArtifactCopyResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        artifact_copy_response.additional_properties = d
        return artifact_copy_response
