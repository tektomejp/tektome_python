...
T = TypeVar("T", bound="SimpleAttributeTypeActionSchemaDatetimeOnOrBefore")


@_attrs_define
class SimpleAttributeTypeActionSchemaDatetimeOnOrBefore:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        simple_attribute_type_action_schema_datetime_on_or_before.additional_properties = d
        return simple_attribute_type_action_schema_datetime_on_or_before
