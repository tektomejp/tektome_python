...
if TYPE_CHECKING:
    from ..models.attribute_response_value_type_7 import AttributeResponseValueType7
...
class AttributeResponse:
    ...
    Attributes:
        ...
        id (UUID):
        type_ (str):
        value (AttributeResponseValueType7 | bool | datetime.date | datetime.datetime | float | int | list[Any] | None |
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            ...
            value = self.value.isoformat()
        elif isinstance(self.value, AttributeResponseValueType7):
        ...
        def _parse_value(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_7 = AttributeResponseValueType7.from_dict(data)
