...
T = TypeVar("T", bound="ASimulateLongCallResponse")


@_attrs_define
class ASimulateLongCallResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        a_simulate_long_call_response = cls(
            sync_delay=sync_delay,
            async_delay=async_delay,
        )

        a_simulate_long_call_response.additional_properties = d
        return a_simulate_long_call_response
