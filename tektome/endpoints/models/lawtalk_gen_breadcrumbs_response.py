...
if TYPE_CHECKING:
    ...
    from ..models.gen_breadcrumbs_resource_group_response import GenBreadcrumbsResourceGroupResponse


T = TypeVar("T", bound="LawtalkGenBreadcrumbsResponse")


@_attrs_define
class LawtalkGenBreadcrumbsResponse:
    """
    Attributes:
        resource_group (GenBreadcrumbsResourceGroupResponse):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        resource_group = GenBreadcrumbsResourceGroupResponse.from_dict(d.pop("resource_group"))
        ...
        lawtalk_gen_breadcrumbs_response = cls(
            resource_group=resource_group,
            parents=parents,
        )

        lawtalk_gen_breadcrumbs_response.additional_properties = d
        return lawtalk_gen_breadcrumbs_response
