...
T = TypeVar("T", bound="SectionCreationPostIn")


@_attrs_define
class SectionCreationPostIn:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        section_creation_post_in.additional_properties = d
        return section_creation_post_in
