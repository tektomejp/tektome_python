...
T = TypeVar("T", bound="ImportResourceGroupPostIn")


@_attrs_define
class ImportResourceGroupPostIn:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        import_resource_group_post_in = cls(
            resource_group_ids=resource_group_ids,
        )

        import_resource_group_post_in.additional_properties = d
        return import_resource_group_post_in
