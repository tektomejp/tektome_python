...
T = TypeVar("T", bound="DynamicFloatSearchCondition")


@_attrs_define
class DynamicFloatSearchCondition:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        value = DynamicFloatValue.from_dict(d.pop("value"))

        dynamic_float_search_condition = cls(
            attribute_name=attribute_name,
            attribute_type=attribute_type,
            action=action,
            value=value,
        ...
        dynamic_float_search_condition.additional_properties = d
        return dynamic_float_search_condition
