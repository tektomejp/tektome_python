...
T = TypeVar("T", bound="LawtalkResourceGroupSchema")


@_attrs_define
class LawtalkResourceGroupSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_resource_group_schema = cls(
            lawtalk_attributes=lawtalk_attributes,
            core_attributes=core_attributes,
            file_count=file_count,
            root_folder=root_folder,
        ...
        lawtalk_resource_group_schema.additional_properties = d
        return lawtalk_resource_group_schema
