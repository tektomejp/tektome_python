...
T = TypeVar("T", bound="CreateRecommendResourceGroupRequest")


@_attrs_define
class CreateRecommendResourceGroupRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_recommend_resource_group_request = cls(
        ...
        create_recommend_resource_group_request.additional_properties = d
        return create_recommend_resource_group_request
