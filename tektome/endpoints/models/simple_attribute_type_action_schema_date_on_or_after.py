...
T = TypeVar("T", bound="SimpleAttributeTypeActionSchemaDateOnOrAfter")


@_attrs_define
class SimpleAttributeTypeActionSchemaDateOnOrAfter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        simple_attribute_type_action_schema_date_on_or_after.additional_properties = d
        return simple_attribute_type_action_schema_date_on_or_after
