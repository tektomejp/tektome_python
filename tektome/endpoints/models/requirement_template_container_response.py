...
if TYPE_CHECKING:
    from ..models.requirement_template_resources_response import RequirementTemplateResourcesResponse
    from ..models.user_metadata import UserMetadata


T = TypeVar("T", bound="RequirementTemplateContainerResponse")


@_attrs_define
class RequirementTemplateContainerResponse:
    ...
    Attributes:
        ...
        public_resource_groups (list[RequirementTemplateResourcesResponse] | Unset):
    ...
    created: datetime.datetime
    updated: datetime.datetime
    public_resource_groups: list[RequirementTemplateResourcesResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _public_resource_groups is not UNSET:
            ...
            for public_resource_groups_item_data in _public_resource_groups:
                public_resource_groups_item = RequirementTemplateResourcesResponse.from_dict(
        ...
        requirement_template_container_response = cls(
            created_by=created_by,
            updated_by=updated_by,
            name=name,
            created=created,
        ...
        requirement_template_container_response.additional_properties = d
        return requirement_template_container_response
