...
T = TypeVar("T", bound="BIMCitationPathParams")


@_attrs_define
class BIMCitationPathParams:
    """
    Attributes:
        attribute_id (UUID):
        dataspace_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bim_citation_path_params.additional_properties = d
        return bim_citation_path_params
