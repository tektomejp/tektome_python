...
T = TypeVar("T", bound="PaymentRecordOut")


@_attrs_define
class PaymentRecordOut:
    """
    Attributes:
        supporting_file (str):
        ...
        balance_after (float | str | Unset):  Default: 0.0.
        balance_before (float | str | Unset):  Default: 0.0.
    """
    ...
    balance_after: float | str | Unset = 0.0
    balance_before: float | str | Unset = 0.0
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        balance_after: float | str | Unset
        if isinstance(self.balance_after, Unset):
            balance_after = UNSET
        else:
            balance_after = self.balance_after

        balance_before: float | str | Unset
        if isinstance(self.balance_before, Unset):
            balance_before = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_balance_after(data: object) -> float | str | Unset:
            if isinstance(data, Unset):
                return data
            return cast(float | str | Unset, data)

        balance_after = _parse_balance_after(d.pop("balance_after", UNSET))

        def _parse_balance_before(data: object) -> float | str | Unset:
            if isinstance(data, Unset):
                return data
            return cast(float | str | Unset, data)

        balance_before = _parse_balance_before(d.pop("balance_before", UNSET))

        payment_record_out = cls(
            supporting_file=supporting_file,
            created_by=created_by,
            updated_by=updated_by,
            transaction_type=transaction_type,
        ...
        payment_record_out.additional_properties = d
        return payment_record_out
