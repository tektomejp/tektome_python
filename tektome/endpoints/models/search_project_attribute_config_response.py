...
if TYPE_CHECKING:
    from ..models.search_project_attribute_config_response_attribute_metadata_type_0 import (
        SearchProjectAttributeConfigResponseAttributeMetadataType0,
    )
    from ..models.user_metadata import UserMetadata


T = TypeVar("T", bound="SearchProjectAttributeConfigResponse")


@_attrs_define
class SearchProjectAttributeConfigResponse:
    """Lightweight schema for project attribute configs in DS search context.
    Excludes process_details to avoid unnecessary process_set queries.
        ...
        Attributes:
            ...
            attribute_metadata (None | SearchProjectAttributeConfigResponseAttributeMetadataType0 | Unset):
    ...
    attribute_metadata: None | SearchProjectAttributeConfigResponseAttributeMetadataType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.attribute_metadata, SearchProjectAttributeConfigResponseAttributeMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_attribute_metadata(
            data: object,
        ) -> None | SearchProjectAttributeConfigResponseAttributeMetadataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                attribute_metadata_type_0 = SearchProjectAttributeConfigResponseAttributeMetadataType0.from_dict(data)

                return attribute_metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SearchProjectAttributeConfigResponseAttributeMetadataType0 | Unset, data)
        ...
        search_project_attribute_config_response = cls(
            created_by=created_by,
            updated_by=updated_by,
            attribute_name=attribute_name,
            attribute_type=attribute_type,
        ...
        search_project_attribute_config_response.additional_properties = d
        return search_project_attribute_config_response
