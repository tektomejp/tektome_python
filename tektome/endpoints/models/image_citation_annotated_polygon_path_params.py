...
T = TypeVar("T", bound="ImageCitationAnnotatedPolygonPathParams")


@_attrs_define
class ImageCitationAnnotatedPolygonPathParams:
    """
    Attributes:
        attribute_id (UUID):
        dataspace_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_citation_annotated_polygon_path_params = cls(
            attribute_id=attribute_id,
            dataspace_id=dataspace_id,
            attribute_category=attribute_category,
            image_citation_id=image_citation_id,
        ...
        image_citation_annotated_polygon_path_params.additional_properties = d
        return image_citation_annotated_polygon_path_params
