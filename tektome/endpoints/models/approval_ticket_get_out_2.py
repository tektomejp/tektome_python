...
T = TypeVar("T", bound="ApprovalTicketGetOut2")


@_attrs_define
class ApprovalTicketGetOut2:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        approval_ticket_get_out_2.additional_properties = d
        return approval_ticket_get_out_2
