...
T = TypeVar("T", bound="DataspaceResourceResultHit")


@_attrs_define
class DataspaceResourceResultHit:
    """A resource hit with nested parent project hit.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return dataspace_resource_result_hit
