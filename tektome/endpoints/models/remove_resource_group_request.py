...
T = TypeVar("T", bound="RemoveResourceGroupRequest")


@_attrs_define
class RemoveResourceGroupRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        remove_resource_group_request = cls(
            resource_group_ids=resource_group_ids,
        )

        remove_resource_group_request.additional_properties = d
        return remove_resource_group_request
