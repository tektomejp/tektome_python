...
T = TypeVar("T", bound="ProjectPatchMembersSchemaIn")


@_attrs_define
class ProjectPatchMembersSchemaIn:
    """
    Attributes:
        user_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_patch_members_schema_in = cls(
            user_id=user_id,
            role_name=role_name,
        )

        project_patch_members_schema_in.additional_properties = d
        return project_patch_members_schema_in
