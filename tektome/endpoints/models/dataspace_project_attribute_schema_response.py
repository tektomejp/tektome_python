...
if TYPE_CHECKING:
    ...
    from ..models.dataspace_project_attribute_schema_response_attribute_metadata_type_0 import (
        DataspaceProjectAttributeSchemaResponseAttributeMetadataType0,
    )
    from ..models.user_metadata import UserMetadata


T = TypeVar("T", bound="DataspaceProjectAttributeSchemaResponse")


@_attrs_define
class DataspaceProjectAttributeSchemaResponse:
    """Schema for the response of project attributes in a dataspace.
    ...
    Attributes:
        ...
        attribute_metadata (DataspaceProjectAttributeSchemaResponseAttributeMetadataType0 | None | Unset):
    ...
    attribute_metadata: DataspaceProjectAttributeSchemaResponseAttributeMetadataType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.attribute_metadata, DataspaceProjectAttributeSchemaResponseAttributeMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_attribute_metadata(
            data: object,
        ) -> DataspaceProjectAttributeSchemaResponseAttributeMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                attribute_metadata_type_0 = DataspaceProjectAttributeSchemaResponseAttributeMetadataType0.from_dict(
                    data
                )
                ...
                pass
            return cast(DataspaceProjectAttributeSchemaResponseAttributeMetadataType0 | None | Unset, data)
        ...
        dataspace_project_attribute_schema_response = cls(
            created_by=created_by,
            updated_by=updated_by,
            attribute_name=attribute_name,
            attribute_type=attribute_type,
        ...
        dataspace_project_attribute_schema_response.additional_properties = d
        return dataspace_project_attribute_schema_response
