...
T = TypeVar("T", bound="CreateRetrieveBimSheetRequest")


@_attrs_define
class CreateRetrieveBimSheetRequest:
    """
    Attributes:
        bim_project_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_retrieve_bim_sheet_request = cls(
            bim_project_id=bim_project_id,
            only_ids=only_ids,
        ...
        create_retrieve_bim_sheet_request.additional_properties = d
        return create_retrieve_bim_sheet_request
