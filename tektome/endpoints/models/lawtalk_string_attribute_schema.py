...
T = TypeVar("T", bound="LawtalkStringAttributeSchema")


@_attrs_define
class LawtalkStringAttributeSchema:
    """
    Attributes:
        name (str):
        value (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_string_attribute_schema = cls(
            name=name,
            value=value,
            operator=operator,
        )

        lawtalk_string_attribute_schema.additional_properties = d
        return lawtalk_string_attribute_schema
