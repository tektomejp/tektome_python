...
T = TypeVar("T", bound="ReplaceSystemAttributeBodyRequest")


@_attrs_define
class ReplaceSystemAttributeBodyRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        replace_system_attribute_body_request = cls(
        ...
        replace_system_attribute_body_request.additional_properties = d
        return replace_system_attribute_body_request
