...
T = TypeVar("T", bound="RetrieveBimViewsInProjectPostIn")


@_attrs_define
class RetrieveBimViewsInProjectPostIn:
    """
    Attributes:
        bim_project_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        retrieve_bim_views_in_project_post_in = cls(
            bim_project_id=bim_project_id,
            only_ids=only_ids,
        ...
        retrieve_bim_views_in_project_post_in.additional_properties = d
        return retrieve_bim_views_in_project_post_in
