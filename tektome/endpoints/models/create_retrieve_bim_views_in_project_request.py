...
T = TypeVar("T", bound="CreateRetrieveBimViewsInProjectRequest")


@_attrs_define
class CreateRetrieveBimViewsInProjectRequest:
    """
    Attributes:
        bim_project_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_retrieve_bim_views_in_project_request = cls(
            bim_project_id=bim_project_id,
            only_ids=only_ids,
        ...
        create_retrieve_bim_views_in_project_request.additional_properties = d
        return create_retrieve_bim_views_in_project_request
