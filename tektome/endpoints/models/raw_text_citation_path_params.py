...
T = TypeVar("T", bound="RawTextCitationPathParams")


@_attrs_define
class RawTextCitationPathParams:
    """
    Attributes:
        attribute_id (UUID):
        dataspace_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        raw_text_citation_path_params = cls(
            attribute_id=attribute_id,
            dataspace_id=dataspace_id,
            attribute_category=attribute_category,
            rawtext_citation_id=rawtext_citation_id,
        ...
        raw_text_citation_path_params.additional_properties = d
        return raw_text_citation_path_params
