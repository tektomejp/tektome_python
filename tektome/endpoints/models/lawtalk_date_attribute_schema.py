...
@_attrs_define
class LawtalkDateAttributeSchema:
    """
    Attributes:
        name (str):
        value (datetime.date):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_date_attribute_schema = cls(
            name=name,
            value=value,
            operator=operator,
        )

        lawtalk_date_attribute_schema.additional_properties = d
        return lawtalk_date_attribute_schema
