...
T = TypeVar("T", bound="UnitedKingdomProjectAttributes")


@_attrs_define
class UnitedKingdomProjectAttributes:
    """United Kingdom project attributes
    ...
    Attributes:
        ...
        region (str):
        country (Literal['united_kingdom'] | Unset):  Default: 'united_kingdom'.
        structures (list[str] | None | Unset):
        site_area (float | None | Unset):
        site_area_operator (None | Operators | Unset):
        floors_above_ground (int | None | Unset):
        floors_above_ground_operator (None | Operators | Unset):
        floors_below_ground (int | None | Unset):
        floors_below_ground_operator (None | Operators | Unset):
        height (float | None | Unset):
        height_operator (None | Operators | Unset):
        other_details (None | str | Unset):
        building_types (list[str] | None | Unset):
        gross_external_area (float | None | Unset):
        gross_external_area_operator (None | Operators | Unset):
        gross_internal_area (float | None | Unset):
        gross_internal_area_operator (None | Operators | Unset):
        net_internal_area (float | None | Unset):
        net_internal_area_operator (None | Operators | Unset):
        proposed_development (None | str | Unset):
        other_restrictions (None | str | Unset):
        local_planning_authority (None | str | Unset):
    """
    ...
    coordinates: Coordinate
    region: str
    country: Literal["united_kingdom"] | Unset = "united_kingdom"
    structures: list[str] | None | Unset = UNSET
    site_area: float | None | Unset = UNSET
    site_area_operator: None | Operators | Unset = UNSET
    floors_above_ground: int | None | Unset = UNSET
    floors_above_ground_operator: None | Operators | Unset = UNSET
    floors_below_ground: int | None | Unset = UNSET
    floors_below_ground_operator: None | Operators | Unset = UNSET
    height: float | None | Unset = UNSET
    height_operator: None | Operators | Unset = UNSET
    other_details: None | str | Unset = UNSET
    building_types: list[str] | None | Unset = UNSET
    gross_external_area: float | None | Unset = UNSET
    gross_external_area_operator: None | Operators | Unset = UNSET
    gross_internal_area: float | None | Unset = UNSET
    gross_internal_area_operator: None | Operators | Unset = UNSET
    net_internal_area: float | None | Unset = UNSET
    net_internal_area_operator: None | Operators | Unset = UNSET
    proposed_development: None | str | Unset = UNSET
    other_restrictions: None | str | Unset = UNSET
    local_planning_authority: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.site_area_operator, Operators):
        ...
        elif isinstance(self.floors_above_ground_operator, Operators):
        ...
        elif isinstance(self.floors_below_ground_operator, Operators):
        ...
        elif isinstance(self.height_operator, Operators):
        ...
        elif isinstance(self.gross_external_area_operator, Operators):
        ...
        elif isinstance(self.gross_internal_area_operator, Operators):
        ...
        elif isinstance(self.net_internal_area_operator, Operators):
        ...
        local_planning_authority: None | str | Unset
        if isinstance(self.local_planning_authority, Unset):
            local_planning_authority = UNSET
        else:
            local_planning_authority = self.local_planning_authority
        ...
        if local_planning_authority is not UNSET:
            field_dict["local_planning_authority"] = local_planning_authority
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        country = cast(Literal["united_kingdom"] | Unset, d.pop("country", UNSET))
        if country != "united_kingdom" and not isinstance(country, Unset):
            raise ValueError(f"country must match const 'united_kingdom', got '{country}'")
        ...
        def _parse_site_area_operator(data: object) -> None | Operators | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | Operators | Unset, data)
        ...
        def _parse_floors_above_ground_operator(data: object) -> None | Operators | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_floors_below_ground_operator(data: object) -> None | Operators | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_height_operator(data: object) -> None | Operators | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_gross_external_area_operator(data: object) -> None | Operators | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_gross_internal_area_operator(data: object) -> None | Operators | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_net_internal_area_operator(data: object) -> None | Operators | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_local_planning_authority(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        local_planning_authority = _parse_local_planning_authority(d.pop("local_planning_authority", UNSET))

        united_kingdom_project_attributes = cls(
            name=name,
            planned_construction_start_date=planned_construction_start_date,
            street_address=street_address,
            coordinates=coordinates,
        ...
        united_kingdom_project_attributes.additional_properties = d
        return united_kingdom_project_attributes
