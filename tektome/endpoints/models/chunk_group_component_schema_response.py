...
T = TypeVar("T", bound="ChunkGroupComponentSchemaResponse")


@_attrs_define
class ChunkGroupComponentSchemaResponse:
    """
    Attributes:
        chunks (list[Chunk]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chunk_group_component_schema_response = cls(
            chunks=chunks,
            created=created,
            updated=updated,
            resource=resource,
        ...
        chunk_group_component_schema_response.additional_properties = d
        return chunk_group_component_schema_response
