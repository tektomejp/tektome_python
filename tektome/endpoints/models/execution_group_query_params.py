...
from ..models.execution_group_query_params_execution_group_status import ExecutionGroupQueryParamsExecutionGroupStatus
from ..models.execution_group_query_params_execution_review_status import ExecutionGroupQueryParamsExecutionReviewStatus
from ..models.execution_group_query_params_process_type_choices import ExecutionGroupQueryParamsProcessTypeChoices
from ..types import UNSET, Unset

T = TypeVar("T", bound="ExecutionGroupQueryParams")


@_attrs_define
class ExecutionGroupQueryParams:
    """Query parameters for filtering execution groups.

    Attributes:
        process_types (list[ExecutionGroupQueryParamsProcessTypeChoices] | Unset): Process types
        process_ids (list[UUID] | Unset): Process IDs
        status (list[ExecutionGroupQueryParamsExecutionGroupStatus] | Unset): Execution group statuses
        review_status (list[ExecutionGroupQueryParamsExecutionReviewStatus] | Unset): Execution's review statuses
    ...
    status: list[ExecutionGroupQueryParamsExecutionGroupStatus] | Unset = UNSET
    review_status: list[ExecutionGroupQueryParamsExecutionReviewStatus] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _process_types is not UNSET:
            ...
            for process_types_item_data in _process_types:
                process_types_item = ExecutionGroupQueryParamsProcessTypeChoices(process_types_item_data)
        ...
        if _status is not UNSET:
            ...
            for status_item_data in _status:
                status_item = ExecutionGroupQueryParamsExecutionGroupStatus(status_item_data)
        ...
        if _review_status is not UNSET:
            ...
            for review_status_item_data in _review_status:
                review_status_item = ExecutionGroupQueryParamsExecutionReviewStatus(review_status_item_data)
        ...
        return execution_group_query_params
