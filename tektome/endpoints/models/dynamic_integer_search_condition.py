...
T = TypeVar("T", bound="DynamicIntegerSearchCondition")


@_attrs_define
class DynamicIntegerSearchCondition:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        value = DynamicIntegerValue.from_dict(d.pop("value"))

        dynamic_integer_search_condition = cls(
            attribute_name=attribute_name,
            attribute_type=attribute_type,
            action=action,
            value=value,
        ...
        dynamic_integer_search_condition.additional_properties = d
        return dynamic_integer_search_condition
