...
if TYPE_CHECKING:
    from ..models.json_attribute_schema_response_value_type_0 import JSONAttributeSchemaResponseValueType0


T = TypeVar("T", bound="JSONAttributeSchemaResponse")


@_attrs_define
class JSONAttributeSchemaResponse:
    """
    Attributes:
        ...
        value (JSONAttributeSchemaResponseValueType0 | None | Unset):
    """
    ...
    value: JSONAttributeSchemaResponseValueType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, JSONAttributeSchemaResponseValueType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> JSONAttributeSchemaResponseValueType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = JSONAttributeSchemaResponseValueType0.from_dict(data)

                return value_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(JSONAttributeSchemaResponseValueType0 | None | Unset, data)

        value = _parse_value(d.pop("value", UNSET))

        json_attribute_schema_response = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        json_attribute_schema_response.additional_properties = d
        return json_attribute_schema_response
