...
if TYPE_CHECKING:
    from ..models.project_requirement_item_table_response_value_item import ProjectRequirementItemTableResponseValueItem


T = TypeVar("T", bound="ProjectRequirementItemTableResponse")


@_attrs_define
class ProjectRequirementItemTableResponse:
    """
    Attributes:
        value (list[ProjectRequirementItemTableResponseValueItem] | Unset):
        id (None | Unset | UUID):
        nonce (int | Unset):  Default: 0.
        extraction_status (None | str | Unset):  Default: 'pending'.
    """

    value: list[ProjectRequirementItemTableResponseValueItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.project_requirement_item_table_response_value_item import (
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = ProjectRequirementItemTableResponseValueItem.from_dict(value_item_data)
        ...
        project_requirement_item_table_response = cls(
            value=value,
            id=id,
            nonce=nonce,
        ...
        project_requirement_item_table_response.additional_properties = d
        return project_requirement_item_table_response
