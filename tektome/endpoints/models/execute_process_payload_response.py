...
if TYPE_CHECKING:
    ...
    from ..models.execute_process_payload_response_execution_run_args import (
...
T = TypeVar("T", bound="ExecuteProcessPayloadResponse")


@_attrs_define
class ExecuteProcessPayloadResponse:
    """Validation schema for individual process execution payload

    Attributes:
        execution_run_args (ExecuteProcessPayloadResponseExecutionRunArgs):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        execution_run_args = ExecuteProcessPayloadResponseExecutionRunArgs.from_dict(d.pop("execution_run_args"))
        ...
        execute_process_payload_response = cls(
            execution_run_args=execution_run_args,
            process_details=process_details,
            ui_trigger_details=ui_trigger_details,
        )

        execute_process_payload_response.additional_properties = d
        return execute_process_payload_response
