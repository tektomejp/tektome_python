...
if TYPE_CHECKING:
    ...
    from ..models.requirement_research_templates_get_out_project_specific_resource_groups_keywords import (
...
T = TypeVar("T", bound="RequirementResearchTemplatesGetOut")


@_attrs_define
class RequirementResearchTemplatesGetOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_project_specific_resource_groups_keywords, Unset):
            ...
            project_specific_resource_groups_keywords = (
                RequirementResearchTemplatesGetOutProjectSpecificResourceGroupsKeywords.from_dict(
        ...
        return requirement_research_templates_get_out
