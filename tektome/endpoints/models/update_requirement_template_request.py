...
T = TypeVar("T", bound="UpdateRequirementTemplateRequest")


@_attrs_define
class UpdateRequirementTemplateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_requirement_template_request = cls(
            title=title,
            status=status,
            requirement_item_attribute_table=requirement_item_attribute_table,
        )

        update_requirement_template_request.additional_properties = d
        return update_requirement_template_request
