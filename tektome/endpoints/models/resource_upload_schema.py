...
T = TypeVar("T", bound="ResourceUploadSchema")


@_attrs_define
class ResourceUploadSchema:
    """Schema for blob upload completion endpoint with BIM project info.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resource_upload_schema.additional_properties = d
        return resource_upload_schema
