...
if TYPE_CHECKING:
    from ..models.resource_groups_response import ResourceGroupsResponse
...
class PagedResourceGroupsGetOut:
    ...
    Attributes:
        count (int):
        total_page (int):
        items (list[ResourceGroupsResponse]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ResourceGroupsResponse.from_dict(items_item_data)
