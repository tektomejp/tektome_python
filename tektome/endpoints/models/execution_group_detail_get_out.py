...
T = TypeVar("T", bound="ExecutionGroupDetailGetOut")


@_attrs_define
class ExecutionGroupDetailGetOut:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        execution_group_detail_get_out = cls(
            created_by=created_by,
            updated_by=updated_by,
            launched_by=launched_by,
            approvals_count=approvals_count,
        ...
        execution_group_detail_get_out.additional_properties = d
        return execution_group_detail_get_out
