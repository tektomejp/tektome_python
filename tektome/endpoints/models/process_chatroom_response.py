...
class ProcessChatroomResponse:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        process: None | str | Unset
        if isinstance(self.process, Unset):
            process = UNSET
        elif isinstance(self.process, UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_process(data: object) -> None | Unset | UUID:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        process = _parse_process(d.pop("process", UNSET))
