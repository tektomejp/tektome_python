...
class UpdateOrganizationMultiPartBodyParams:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_organization_multi_part_body_params = cls(
            payload=payload,
            logo_file=logo_file,
        )

        update_organization_multi_part_body_params.additional_properties = d
        return update_organization_multi_part_body_params
