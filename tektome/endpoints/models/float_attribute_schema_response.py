...
T = TypeVar("T", bound="FloatAttributeSchemaResponse")


@_attrs_define
class FloatAttributeSchemaResponse:
    """
    Attributes:
        created (datetime.datetime):
        updated (datetime.datetime):
        name (str):
        attribute_type (Literal['float_attributes'] | Unset):  Default: 'float_attributes'.
        id (None | Unset | UUID):
    ...
    updated: datetime.datetime
    name: str
    attribute_type: Literal["float_attributes"] | Unset = "float_attributes"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attribute_type = cast(Literal["float_attributes"] | Unset, d.pop("attribute_type", UNSET))
        if attribute_type != "float_attributes" and not isinstance(attribute_type, Unset):
            raise ValueError(f"attribute_type must match const 'float_attributes', got '{attribute_type}'")
        ...
        float_attribute_schema_response = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        float_attribute_schema_response.additional_properties = d
        return float_attribute_schema_response
