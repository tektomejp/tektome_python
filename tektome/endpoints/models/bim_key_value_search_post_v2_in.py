...
T = TypeVar("T", bound="BimKeyValueSearchPostV2In")


@_attrs_define
class BimKeyValueSearchPostV2In:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bim_key_value_search_post_v2_in = cls(
            key=key,
            value=value,
        )

        bim_key_value_search_post_v2_in.additional_properties = d
        return bim_key_value_search_post_v2_in
