...
if TYPE_CHECKING:
    ...
    from ..models.executions_response_metadata import ExecutionsResponseMetadata
...
class ExecutionsResponse:
    ...
    Attributes:
        ...
        metadata (ExecutionsResponseMetadata | Unset): The raw metadata received for this specific execution
    ...
    metadata: ExecutionsResponseMetadata | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        metadata: ExecutionsResponseMetadata | Unset
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ExecutionsResponseMetadata.from_dict(_metadata)
