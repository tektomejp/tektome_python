...
if TYPE_CHECKING:
    from ..models.polygon_attribute_schema_response_value_type_0 import PolygonAttributeSchemaResponseValueType0


T = TypeVar("T", bound="PolygonAttributeSchemaResponse")


@_attrs_define
class PolygonAttributeSchemaResponse:
    """
    Attributes:
        ...
        value (None | PolygonAttributeSchemaResponseValueType0 | Unset):
    """
    ...
    value: None | PolygonAttributeSchemaResponseValueType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, PolygonAttributeSchemaResponseValueType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> None | PolygonAttributeSchemaResponseValueType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = PolygonAttributeSchemaResponseValueType0.from_dict(data)

                return value_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PolygonAttributeSchemaResponseValueType0 | Unset, data)

        value = _parse_value(d.pop("value", UNSET))

        polygon_attribute_schema_response = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        polygon_attribute_schema_response.additional_properties = d
        return polygon_attribute_schema_response
