...
if TYPE_CHECKING:
    from ..models.multi_select_attribute_schema_out_value_type_0 import MultiSelectAttributeSchemaOutValueType0


T = TypeVar("T", bound="MultiSelectAttributeSchemaOut")


@_attrs_define
class MultiSelectAttributeSchemaOut:
    """
    Attributes:
        ...
        value (MultiSelectAttributeSchemaOutValueType0 | None | Unset):
    """
    ...
    value: MultiSelectAttributeSchemaOutValueType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, MultiSelectAttributeSchemaOutValueType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> MultiSelectAttributeSchemaOutValueType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = MultiSelectAttributeSchemaOutValueType0.from_dict(data)

                return value_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(MultiSelectAttributeSchemaOutValueType0 | None | Unset, data)

        value = _parse_value(d.pop("value", UNSET))

        multi_select_attribute_schema_out = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        multi_select_attribute_schema_out.additional_properties = d
        return multi_select_attribute_schema_out
