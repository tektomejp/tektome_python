...
T = TypeVar("T", bound="ExportCSVReportQuery")


@_attrs_define
class ExportCSVReportQuery:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_csv_report_query.additional_properties = d
        return export_csv_report_query
