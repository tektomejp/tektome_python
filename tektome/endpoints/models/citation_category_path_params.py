...
T = TypeVar("T", bound="CitationCategoryPathParams")


@_attrs_define
class CitationCategoryPathParams:
    """
    Attributes:
        attribute_id (UUID):
        dataspace_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        citation_category_path_params = cls(
            attribute_id=attribute_id,
            dataspace_id=dataspace_id,
            attribute_category=attribute_category,
        )

        citation_category_path_params.additional_properties = d
        return citation_category_path_params
