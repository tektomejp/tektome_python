...
if TYPE_CHECKING:
    from ..models.section_response_pages_paragraphs_paths_type_0 import SectionResponsePagesParagraphsPathsType0
    from ..models.section_response_pages_tables_paths_type_0 import SectionResponsePagesTablesPathsType0
...
class SectionResponse:
    ...
    Attributes:
        ...
        pages_paragraphs_paths (None | SectionResponsePagesParagraphsPathsType0 | Unset):
        pages_tables_paths (None | SectionResponsePagesTablesPathsType0 | Unset):
    """
    ...
    pages_paragraphs_paths: None | SectionResponsePagesParagraphsPathsType0 | Unset = UNSET
    pages_tables_paths: None | SectionResponsePagesTablesPathsType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.pages_paragraphs_paths, SectionResponsePagesParagraphsPathsType0):
        ...
        elif isinstance(self.pages_tables_paths, SectionResponsePagesTablesPathsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_pages_paragraphs_paths(data: object) -> None | SectionResponsePagesParagraphsPathsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                pages_paragraphs_paths_type_0 = SectionResponsePagesParagraphsPathsType0.from_dict(data)

                return pages_paragraphs_paths_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SectionResponsePagesParagraphsPathsType0 | Unset, data)

        pages_paragraphs_paths = _parse_pages_paragraphs_paths(d.pop("pages_paragraphs_paths", UNSET))

        def _parse_pages_tables_paths(data: object) -> None | SectionResponsePagesTablesPathsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                pages_tables_paths_type_0 = SectionResponsePagesTablesPathsType0.from_dict(data)

                return pages_tables_paths_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SectionResponsePagesTablesPathsType0 | Unset, data)
