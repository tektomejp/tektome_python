...
T = TypeVar("T", bound="BIMCitationsGetOut")


@_attrs_define
class BIMCitationsGetOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bim_citations_get_out.additional_properties = d
        return bim_citations_get_out
