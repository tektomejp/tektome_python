...
T = TypeVar("T", bound="CreateFolderBulkMoveRequest")


@_attrs_define
class CreateFolderBulkMoveRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_folder_bulk_move_request = cls(
            folder_id=folder_id,
        ...
        create_folder_bulk_move_request.additional_properties = d
        return create_folder_bulk_move_request
