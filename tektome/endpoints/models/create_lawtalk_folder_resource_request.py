...
T = TypeVar("T", bound="CreateLawtalkFolderResourceRequest")


@_attrs_define
class CreateLawtalkFolderResourceRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_lawtalk_folder_resource_request = cls(
            resource_ids=resource_ids,
        )

        create_lawtalk_folder_resource_request.additional_properties = d
        return create_lawtalk_folder_resource_request
