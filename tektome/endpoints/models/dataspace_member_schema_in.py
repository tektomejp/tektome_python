...
T = TypeVar("T", bound="DataspaceMemberSchemaIn")


@_attrs_define
class DataspaceMemberSchemaIn:
    """
    Attributes:
        user_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_member_schema_in = cls(
            user_id=user_id,
            role_name=role_name,
        )

        dataspace_member_schema_in.additional_properties = d
        return dataspace_member_schema_in
