...
class JapanProjectAttributes:
    ...
    Attributes:
        ...
        total_floor_area_operator (None | Operators | Unset):
        specified_area_ratio (float | None | Unset):
        specified_area_ratio_operator (None | Operators | Unset):
        designated_building_coverage_ratio (float | None | Unset):
        designated_building_coverage_ratio_operator (None | Operators | Unset):
        building_area (float | None | Unset):
        building_area_operator (None | Operators | Unset):
        floor_area (float | None | Unset):
        floor_area_operator (None | Operators | Unset):
    ...
    total_floor_area_operator: None | Operators | Unset = UNSET
    specified_area_ratio: float | None | Unset = UNSET
    specified_area_ratio_operator: None | Operators | Unset = UNSET
    designated_building_coverage_ratio: float | None | Unset = UNSET
    designated_building_coverage_ratio_operator: None | Operators | Unset = UNSET
    building_area: float | None | Unset = UNSET
    building_area_operator: None | Operators | Unset = UNSET
    floor_area: float | None | Unset = UNSET
    floor_area_operator: None | Operators | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.total_floor_area_operator, Operators):
        ...
        elif isinstance(self.specified_area_ratio_operator, Operators):
        ...
        elif isinstance(self.designated_building_coverage_ratio_operator, Operators):
        ...
        elif isinstance(self.building_area_operator, Operators):
        ...
        elif isinstance(self.floor_area_operator, Operators):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_total_floor_area_operator(data: object) -> None | Operators | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_specified_area_ratio_operator(data: object) -> None | Operators | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_designated_building_coverage_ratio_operator(data: object) -> None | Operators | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_building_area_operator(data: object) -> None | Operators | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_floor_area_operator(data: object) -> None | Operators | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
