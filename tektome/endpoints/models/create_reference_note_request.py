...
T = TypeVar("T", bound="CreateReferenceNoteRequest")


@_attrs_define
class CreateReferenceNoteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_reference_note_request = cls(
            title=title,
            content=content,
            creation_source=creation_source,
        )

        create_reference_note_request.additional_properties = d
        return create_reference_note_request
