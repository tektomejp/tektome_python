...
if TYPE_CHECKING:
    from ..models.table_attribute_schema_out_value_type_0 import TableAttributeSchemaOutValueType0


T = TypeVar("T", bound="TableAttributeSchemaOut")


@_attrs_define
class TableAttributeSchemaOut:
    """
    Attributes:
        ...
        value (None | TableAttributeSchemaOutValueType0 | Unset):
    """
    ...
    value: None | TableAttributeSchemaOutValueType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, TableAttributeSchemaOutValueType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> None | TableAttributeSchemaOutValueType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = TableAttributeSchemaOutValueType0.from_dict(data)

                return value_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | TableAttributeSchemaOutValueType0 | Unset, data)

        value = _parse_value(d.pop("value", UNSET))

        table_attribute_schema_out = cls(
            created=created,
            updated=updated,
            name=name,
        ...
        table_attribute_schema_out.additional_properties = d
        return table_attribute_schema_out
