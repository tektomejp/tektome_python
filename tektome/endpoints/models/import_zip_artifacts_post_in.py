...
T = TypeVar("T", bound="ImportZipArtifactsPostIn")


@_attrs_define
class ImportZipArtifactsPostIn:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        import_zip_artifacts_post_in = cls(
            url=url,
            base_path=base_path,
        ...
        import_zip_artifacts_post_in.additional_properties = d
        return import_zip_artifacts_post_in
