...
T = TypeVar("T", bound="ResourceMetadataOut")


@_attrs_define
class ResourceMetadataOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resource_metadata_out.additional_properties = d
        return resource_metadata_out
