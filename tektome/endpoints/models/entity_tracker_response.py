...
T = TypeVar("T", bound="EntityTrackerResponse")


@_attrs_define
class EntityTrackerResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_tracker_response.additional_properties = d
        return entity_tracker_response
