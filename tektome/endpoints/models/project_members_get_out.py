...
T = TypeVar("T", bound="ProjectMembersGetOut")


@_attrs_define
class ProjectMembersGetOut:
    """Schema for retrieving each member in a project.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_members_get_out.additional_properties = d
        return project_members_get_out
