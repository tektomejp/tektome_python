...
T = TypeVar("T", bound="AffectedRequirementOut")


@_attrs_define
class AffectedRequirementOut:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        affected_requirement_out.additional_properties = d
        return affected_requirement_out
