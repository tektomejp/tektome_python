...
T = TypeVar("T", bound="EntityTrackerDataRequest")


@_attrs_define
class EntityTrackerDataRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        view_mode = d.pop("view_mode")

        entity_tracker_data_request = cls(
            observed_entity=observed_entity,
            scoping_entity=scoping_entity,
            view_mode=view_mode,
        )

        entity_tracker_data_request.additional_properties = d
        return entity_tracker_data_request
