...
if TYPE_CHECKING:
    from ..models.polygon_attribute_schema_out_value_type_0 import PolygonAttributeSchemaOutValueType0


T = TypeVar("T", bound="PolygonAttributeSchemaOut")


@_attrs_define
class PolygonAttributeSchemaOut:
    """
    Attributes:
        ...
        value (None | PolygonAttributeSchemaOutValueType0 | Unset):
    """
    ...
    value: None | PolygonAttributeSchemaOutValueType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, PolygonAttributeSchemaOutValueType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> None | PolygonAttributeSchemaOutValueType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = PolygonAttributeSchemaOutValueType0.from_dict(data)

                return value_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PolygonAttributeSchemaOutValueType0 | Unset, data)

        value = _parse_value(d.pop("value", UNSET))

        polygon_attribute_schema_out = cls(
            created=created,
            updated=updated,
            name=name,
            id=id,
        ...
        polygon_attribute_schema_out.additional_properties = d
        return polygon_attribute_schema_out
