...
T = TypeVar("T", bound="LawtalkEmptyProjectResponse")


@_attrs_define
class LawtalkEmptyProjectResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lawtalk_empty_project_response = cls(
            core_attributes=core_attributes,
            created=created,
            updated=updated,
            id=id,
        ...
        lawtalk_empty_project_response.additional_properties = d
        return lawtalk_empty_project_response
