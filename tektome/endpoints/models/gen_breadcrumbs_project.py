...
T = TypeVar("T", bound="GenBreadcrumbsProject")


@_attrs_define
class GenBreadcrumbsProject:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gen_breadcrumbs_project = cls(
            core_attributes=core_attributes,
            id=id,
        )

        gen_breadcrumbs_project.additional_properties = d
        return gen_breadcrumbs_project
