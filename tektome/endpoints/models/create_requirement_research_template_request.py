...
T = TypeVar("T", bound="CreateRequirementResearchTemplateRequest")


@_attrs_define
class CreateRequirementResearchTemplateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_requirement_research_template_request = cls(
            name=name,
            prompt=prompt,
            research_mode=research_mode,
        ...
        create_requirement_research_template_request.additional_properties = d
        return create_requirement_research_template_request
