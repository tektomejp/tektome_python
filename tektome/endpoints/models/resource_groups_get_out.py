...
T = TypeVar("T", bound="ResourceGroupsGetOut")


@_attrs_define
class ResourceGroupsGetOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resource_groups_get_out.additional_properties = d
        return resource_groups_get_out
