...
if TYPE_CHECKING:
    from ..models.requirement_research_template_config import RequirementResearchTemplateConfig
    from ..models.requirement_research_templates_response_project_specific_resource_groups_keywords import (
        RequirementResearchTemplatesResponseProjectSpecificResourceGroupsKeywords,
    )
    from ..models.research_template_resources_response import ResearchTemplateResourcesResponse
    from ..models.user_metadata import UserMetadata


T = TypeVar("T", bound="RequirementResearchTemplatesResponse")


@_attrs_define
class RequirementResearchTemplatesResponse:
    """
    Attributes:
        public_resource_groups (list[ResearchTemplateResourcesResponse]):
        ...
        config (RequirementResearchTemplateConfig):
        id (None | Unset | UUID):
        prompt (None | str | Unset):
        project_specific_resource_groups_keywords
            (RequirementResearchTemplatesResponseProjectSpecificResourceGroupsKeywords | Unset):
        output_format_prompt (None | str | Unset):
        is_interactive_prompt_required (bool | Unset): If True, the interactive clarifying questions step is mandatory
            before running Deep Research. If False, users can optionally access the interactive prompt via 'Improve my
            questions' link. Default: False.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for public_resource_groups_item_data in _public_resource_groups:
            public_resource_groups_item = ResearchTemplateResourcesResponse.from_dict(public_resource_groups_item_data)
        ...
        config = RequirementResearchTemplateConfig.from_dict(d.pop("config"))
        ...
        if isinstance(_project_specific_resource_groups_keywords, Unset):
            ...
            project_specific_resource_groups_keywords = (
                RequirementResearchTemplatesResponseProjectSpecificResourceGroupsKeywords.from_dict(
        ...
        requirement_research_templates_response = cls(
            public_resource_groups=public_resource_groups,
            created_by=created_by,
            updated_by=updated_by,
            name=name,
        ...
        requirement_research_templates_response.additional_properties = d
        return requirement_research_templates_response
