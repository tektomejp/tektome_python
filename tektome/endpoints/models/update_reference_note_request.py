...
T = TypeVar("T", bound="UpdateReferenceNoteRequest")


@_attrs_define
class UpdateReferenceNoteRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_reference_note_request = cls(
            title=title,
            creation_source=creation_source,
        )

        update_reference_note_request.additional_properties = d
        return update_reference_note_request
