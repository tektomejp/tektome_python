...
if TYPE_CHECKING:
    from ..models.update_attribute_request_value_type_7 import UpdateAttributeRequestValueType7
...
class UpdateAttributeRequest:
    ...
    Attributes:
        name (None | str | Unset):
        value (bool | datetime.date | datetime.datetime | float | int | list[Any] | None | str | Unset |
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            ...
            value = self.value.isoformat()
        elif isinstance(self.value, UpdateAttributeRequestValueType7):
        ...
        def _parse_value(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_7 = UpdateAttributeRequestValueType7.from_dict(data)
