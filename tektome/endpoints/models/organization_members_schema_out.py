...
if TYPE_CHECKING:
    from ..models.organization_members_schema_out_assigned_dataspaces import (
        OrganizationMembersSchemaOutAssignedDataspaces,
    )
    from ..models.organization_members_schema_out_assigned_projects import OrganizationMembersSchemaOutAssignedProjects
    from ..models.user_metadata import UserMetadata


T = TypeVar("T", bound="OrganizationMembersSchemaOut")


@_attrs_define
class OrganizationMembersSchemaOut:
    """
    Attributes:
        id (UUID):
        first_name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.organization_members_schema_out_assigned_projects import (
        ...
        assigned_dataspaces = OrganizationMembersSchemaOutAssignedDataspaces.from_dict(d.pop("assigned_dataspaces"))
        ...
        organization_members_schema_out.additional_properties = d
        return organization_members_schema_out
