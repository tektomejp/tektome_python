...
if TYPE_CHECKING:
    from ..models.template_override_response import TemplateOverrideResponse
    from ..models.template_response_openflow_json import TemplateResponseOpenflowJson
...
class TemplateResponse:
    ...
    Attributes:
        ...
        owner_type (str):
        override_data (None | TemplateOverrideResponse):
        ...
        openflow_json (TemplateResponseOpenflowJson | Unset):
    ...
    openflow_json: TemplateResponseOpenflowJson | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.override_data, TemplateOverrideResponse):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_override_data(data: object) -> None | TemplateOverrideResponse:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                override_data_type_0 = TemplateOverrideResponse.from_dict(data)

                return override_data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | TemplateOverrideResponse, data)
        ...
        if isinstance(_openflow_json, Unset):
            ...
            openflow_json = TemplateResponseOpenflowJson.from_dict(_openflow_json)
