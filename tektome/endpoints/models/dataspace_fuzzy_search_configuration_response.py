...
T = TypeVar("T", bound="DataspaceFuzzySearchConfigurationResponse")


@_attrs_define
class DataspaceFuzzySearchConfigurationResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_fuzzy_search_configuration_response = cls(
            created_by=created_by,
            updated_by=updated_by,
            excluded_project_attributes=excluded_project_attributes,
            excluded_resource_attributes=excluded_resource_attributes,
        ...
        dataspace_fuzzy_search_configuration_response.additional_properties = d
        return dataspace_fuzzy_search_configuration_response
