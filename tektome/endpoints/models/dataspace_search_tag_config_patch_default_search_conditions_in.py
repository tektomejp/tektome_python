...
class DataspaceSearchTagConfigPatchDefaultSearchConditionsIn:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataspace_search_tag_config_patch_default_search_conditions_in.additional_properties = d
        return dataspace_search_tag_config_patch_default_search_conditions_in
