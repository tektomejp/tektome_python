...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/app/lawtalk/projects/{project_id}/remove-resource-group/".format(
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> LawtalkProjectSchema | None:
