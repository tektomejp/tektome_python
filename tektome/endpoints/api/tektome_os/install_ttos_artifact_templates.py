...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/core/agents/os/chatrooms/{chatroom_id}/artifact-templates/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 202:
        response_202 = InstallTtosArtifactTemplatesResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Install artifact template groups into a chatroom
     ...
     Queue installation of one or more artifact template groups into a chatroom. Returns 202 immediately
    — actual artifact creation happens asynchronously via the message queue. Use on_duplicate to control
    conflict resolution: skip (default) ignores existing paths, overwrite updates them, forbid fails on
    any conflict.
...
def sync(
    ...
    *,
    ...
    Returns:
        GenericHttpError | InstallTtosArtifactTemplatesResponse
    """
