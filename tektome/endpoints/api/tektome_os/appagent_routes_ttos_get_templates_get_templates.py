...
from ...models.appagent_routes_ttos_get_templates_get_templates_ui_trigger_kind_choices import (
    AppagentRoutesTtosGetTemplatesGetTemplatesUiTriggerKindChoices,
)
...
def _get_kwargs(
    ...
    *,
    ...
    ui_trigger_kinds: list[AppagentRoutesTtosGetTemplatesGetTemplatesUiTriggerKindChoices] | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        ui_trigger_kinds (list[AppagentRoutesTtosGetTemplatesGetTemplatesUiTriggerKindChoices] |
