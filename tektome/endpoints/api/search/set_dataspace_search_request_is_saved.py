...
from ...models.dataspace_search_request_is_saved_patch_in import DataspaceSearchRequestIsSavedPatchIn
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        dataspace_id (UUID):
        search_request_id (UUID):
        body (DataspaceSearchRequestIsSavedPatchIn): For updating is_saved field of a search
            request
