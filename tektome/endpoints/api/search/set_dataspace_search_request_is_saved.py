...
from ...models.update_dataspace_search_request_is_saved_request import UpdateDataspaceSearchRequestIsSavedRequest
...
def _get_kwargs(
    ...
    *,
    body: UpdateDataspaceSearchRequestIsSavedRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/core/dataspaces/{dataspace_id}/search/requests/{search_request_id}/is-saved/".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        dataspace_id (UUID):
        search_request_id (UUID):
        body (UpdateDataspaceSearchRequestIsSavedRequest): For updating is_saved field of a search
            request
