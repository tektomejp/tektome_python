...
from ...models.delete_attribute_attribute_citation_dataspace_entity_type import (
...
def _get_kwargs(
    dataspace_id: UUID,
    attribute_category: DeleteAttributeAttributeCitationDataspaceEntityType,
    attribute_id: UUID,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/api/core/dataspaces/{dataspace_id}/attributes/{attribute_category}/{attribute_id}/attribute-citations/{cited_attribute_id}/".format(
            dataspace_id=quote(str(dataspace_id), safe=""),
            attribute_category=quote(str(attribute_category), safe=""),
            attribute_id=quote(str(attribute_id), safe=""),
            cited_attribute_id=quote(str(cited_attribute_id), safe=""),
        ),
    }
