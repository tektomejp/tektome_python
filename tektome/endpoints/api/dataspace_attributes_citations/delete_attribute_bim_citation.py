...
from ...models.delete_attribute_bim_citation_dataspace_entity_type import DeleteAttributeBimCitationDataspaceEntityType
from ...types import Response


def _get_kwargs(
    dataspace_id: UUID,
    attribute_category: DeleteAttributeBimCitationDataspaceEntityType,
    attribute_id: UUID,
