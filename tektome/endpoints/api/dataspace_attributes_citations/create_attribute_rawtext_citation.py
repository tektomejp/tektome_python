...
from ...models.create_attribute_rawtext_citation_dataspace_entity_type import (
    CreateAttributeRawtextCitationDataspaceEntityType,
)
from ...models.create_raw_text_citation_request import CreateRawTextCitationRequest
...
def _get_kwargs(
    dataspace_id: UUID,
    attribute_category: CreateAttributeRawtextCitationDataspaceEntityType,
    attribute_id: UUID,
    *,
    body: CreateRawTextCitationRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/core/dataspaces/{dataspace_id}/attributes/{attribute_category}/{attribute_id}/rawtext-citations/".format(
...
) -> ErrorResponse | RawTextCitationSchemaResponse | None:
    if response.status_code == 201:
        response_201 = RawTextCitationSchemaResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | RawTextCitationSchemaResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        attribute_category (CreateAttributeRawtextCitationDataspaceEntityType):
        attribute_id (UUID):
        body (CreateRawTextCitationRequest): Raw text citation input schema.
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | RawTextCitationSchemaResponse
    """
