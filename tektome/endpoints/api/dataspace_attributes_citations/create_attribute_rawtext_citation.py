...
from ...models.raw_text_citation_post_in import RawTextCitationPostIn
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = RawTextCitationSchemaOut.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        attribute_category (CreateAttributeRawtextCitationDataspaceEntityType):
        attribute_id (UUID):
        body (RawTextCitationPostIn): Raw text citation input schema.
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorOut | RawTextCitationSchemaOut
    """
