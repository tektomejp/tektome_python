...
from ...models.appresource_routers_bims_bims_elements_stream_trim_batch_bim_elements_bim_element_type_path import (
    AppresourceRoutersBimsBimsElementsStreamTrimBatchBimElementsBimElementTypePath,
)
...
def _get_kwargs(
    bim_type: AppresourceRoutersBimsBimsElementsStreamTrimBatchBimElementsBimElementTypePath,
    *,
