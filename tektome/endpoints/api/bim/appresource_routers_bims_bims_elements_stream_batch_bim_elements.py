...
from ...models.appresource_routers_bims_bims_elements_stream_batch_bim_elements_bim_element_type_path import (
    AppresourceRoutersBimsBimsElementsStreamBatchBimElementsBimElementTypePath,
)
...
def _get_kwargs(
    bim_type: AppresourceRoutersBimsBimsElementsStreamBatchBimElementsBimElementTypePath,
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/core/resource-groups/bim/bim-elements/{bim_type}/stream/".format(
