...
from ...models.appresource_routers_bims_bims_projects_stream_bim_elements_by_project_bim_element_type_v2_path import (
    AppresourceRoutersBimsBimsProjectsStreamBimElementsByProjectBimElementTypeV2Path,
)
...
def _get_kwargs(
    bim_project_id: UUID,
    bim_type: AppresourceRoutersBimsBimsProjectsStreamBimElementsByProjectBimElementTypeV2Path,
    *,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        bim_project_id (UUID):
        bim_type
            (AppresourceRoutersBimsBimsProjectsStreamBimElementsByProjectBimElementTypeV2Path): An
            enumeration representing different BIM (Building Information Modeling) element types for
            V2 API paths.
