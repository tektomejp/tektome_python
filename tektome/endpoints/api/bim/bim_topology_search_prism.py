...
from ...models.bim_topology_search_prism_post_in import BimTopologySearchPrismPostIn
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/core/resource-groups/bim/bim-tools/topology-search/{bim_project_id}/prism/".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Run BIM topology search with a prism
    ...
    in the BIM project. Search using a closed base outline in the XY plane extruded in the Z direction.
    This is an asynchronous operation. To retrieve the results, use the get_celery_task
    (/api/core/tasks/{task_id}/) endpoint with the task/process ID returned in this response.

    Args:
        bim_project_id (UUID):
        body (BimTopologySearchPrismPostIn): Schema for BIM topology search with prism request.
