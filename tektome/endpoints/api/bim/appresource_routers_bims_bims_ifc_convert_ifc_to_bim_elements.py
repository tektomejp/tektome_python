...
from ...models.appresource_routers_bims_bims_ifc_convert_ifc_to_bim_elements_file_params import (
    AppresourceRoutersBimsBimsIfcConvertIfcToBimElementsFileParams,
)
...
def _get_kwargs(
    bim_project_id: UUID,
    *,
    body: AppresourceRoutersBimsBimsIfcConvertIfcToBimElementsFileParams,
) -> dict[str, Any]:
