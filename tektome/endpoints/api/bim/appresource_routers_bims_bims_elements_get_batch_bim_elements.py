...
from ...models.appresource_routers_bims_bims_elements_get_batch_bim_elements_bim_element_type_path import (
    AppresourceRoutersBimsBimsElementsGetBatchBimElementsBimElementTypePath,
)
...
def _get_kwargs(
    bim_type: AppresourceRoutersBimsBimsElementsGetBatchBimElementsBimElementTypePath,
    *,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        bim_type (AppresourceRoutersBimsBimsElementsGetBatchBimElementsBimElementTypePath): Enum
