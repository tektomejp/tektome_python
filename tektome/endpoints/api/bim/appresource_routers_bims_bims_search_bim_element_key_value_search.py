...
from ...models.appresource_routers_bims_bims_search_bim_element_key_value_search_bim_element_type_v2_path import (
    AppresourceRoutersBimsBimsSearchBimElementKeyValueSearchBimElementTypeV2Path,
)
...
def _get_kwargs(
    bim_element: AppresourceRoutersBimsBimsSearchBimElementKeyValueSearchBimElementTypeV2Path,
    *,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        bim_element
            (AppresourceRoutersBimsBimsSearchBimElementKeyValueSearchBimElementTypeV2Path): An
