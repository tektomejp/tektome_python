...
from ...models.dataspace_search_filter_field_in_patch import DataspaceSearchFilterFieldInPatch
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = DataspaceSearchFilterFieldResponse.from_dict(response.json())
