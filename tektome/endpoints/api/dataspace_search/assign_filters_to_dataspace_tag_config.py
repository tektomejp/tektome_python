...
from ...models.dataspace_search_tag_config_patch_filter_request import DataspaceSearchTagConfigPatchFilterRequest
...
def _get_kwargs(
    ...
    tag_config_id: UUID,
    *,
    body: DataspaceSearchTagConfigPatchFilterRequest,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        dataspace_id (UUID):
        tag_config_id (UUID):
        body (DataspaceSearchTagConfigPatchFilterRequest): Schema for patching a dataspace tag
