...
from ...models.create_resource_vc_schema_request import CreateResourceVCSchemaRequest
from ...models.error_response import ErrorResponse
from ...models.resource_get_many_schema_response import ResourceGetManySchemaResponse
...
def _get_kwargs(
    ...
    *,
    body: CreateResourceVCSchemaRequest,
) -> dict[str, Any]:
...
) -> ErrorResponse | ResourceGetManySchemaResponse | None:
    if response.status_code == 200:
        response_200 = ResourceGetManySchemaResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | ResourceGetManySchemaResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        resource_group_id (UUID):
        body (CreateResourceVCSchemaRequest): Input Schema for looking up multiple Resource
            Version Control
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | ResourceGetManySchemaResponse
    """
