...
from ...models.resource_ocr_schema_post_response import ResourceOCRSchemaPostResponse
...
) -> ErrorResponse | ResourceOCRSchemaPostResponse | None:
    if response.status_code == 201:
        response_201 = ResourceOCRSchemaPostResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | ResourceOCRSchemaPostResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | ResourceOCRSchemaPostResponse
    """
