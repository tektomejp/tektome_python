...
from ...models.appcore_routes_reports_get_export_usage_reports_period_types import (
    AppcoreRoutesReportsGetExportUsageReportsPeriodTypes,
)
...
def _get_kwargs(
    *,
    ...
    period_type: AppcoreRoutesReportsGetExportUsageReportsPeriodTypes,
    month: int,
