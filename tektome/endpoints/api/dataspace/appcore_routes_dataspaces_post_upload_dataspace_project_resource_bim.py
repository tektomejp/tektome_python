...
from ...models.appcore_routes_dataspaces_post_upload_dataspace_project_resource_bim_file_params import (
    AppcoreRoutesDataspacesPostUploadDataspaceProjectResourceBimFileParams,
)
...
def _get_kwargs(
    project_id: UUID,
    *,
    body: AppcoreRoutesDataspacesPostUploadDataspaceProjectResourceBimFileParams,
) -> dict[str, Any]:
