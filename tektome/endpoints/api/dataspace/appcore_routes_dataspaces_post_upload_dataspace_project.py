...
from ...models.appcore_routes_dataspaces_post_upload_dataspace_project_multi_part_body_params import (
    AppcoreRoutesDataspacesPostUploadDataspaceProjectMultiPartBodyParams,
)
...
def _get_kwargs(
    project_id: UUID,
    *,
    body: AppcoreRoutesDataspacesPostUploadDataspaceProjectMultiPartBodyParams,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/core/dataspaces/projects/{project_id}/upload/".format(
