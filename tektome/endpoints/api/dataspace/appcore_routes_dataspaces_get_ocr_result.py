...
from ...models.resource_ocr_schema_get_out import ResourceOCRSchemaGetOut
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ResourceOCRSchemaGetOut.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorOut | ResourceOCRSchemaGetOut
    """
