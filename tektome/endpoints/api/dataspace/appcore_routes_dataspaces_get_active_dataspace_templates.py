...
from ...models.appcore_routes_dataspaces_get_active_dataspace_templates_ui_trigger_kind_choices import (
    AppcoreRoutesDataspacesGetActiveDataspaceTemplatesUiTriggerKindChoices,
)
...
def _get_kwargs(
    ...
    *,
    ...
    ui_trigger_kinds: list[AppcoreRoutesDataspacesGetActiveDataspaceTemplatesUiTriggerKindChoices] | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/core/dataspaces/{dataspace_id}/templates/active/".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        ui_trigger_kinds
            (list[AppcoreRoutesDataspacesGetActiveDataspaceTemplatesUiTriggerKindChoices] | Unset):
