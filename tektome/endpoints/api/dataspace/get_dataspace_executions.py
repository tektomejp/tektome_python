...
def _get_kwargs(
    ...
    *,
    ...
    json_execution_groups: list[str] | Unset = UNSET
    if not isinstance(execution_groups, Unset):
        json_execution_groups = []
        for execution_groups_item_data in execution_groups:
            execution_groups_item = str(execution_groups_item_data)
            json_execution_groups.append(execution_groups_item)

    params["execution_groups"] = json_execution_groups
