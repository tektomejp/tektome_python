...
from ...models.appcore_routes_projects_get_active_project_templates_ui_trigger_kind_choices import (
    AppcoreRoutesProjectsGetActiveProjectTemplatesUiTriggerKindChoices,
)
...
def _get_kwargs(
    ...
    *,
    ...
    ui_trigger_kinds: list[AppcoreRoutesProjectsGetActiveProjectTemplatesUiTriggerKindChoices] | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        ui_trigger_kinds (list[AppcoreRoutesProjectsGetActiveProjectTemplatesUiTriggerKindChoices]
