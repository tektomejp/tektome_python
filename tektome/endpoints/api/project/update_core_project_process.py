...
def sync_detailed(
    ...
    *,
    ...
    """Update a project process
     ...
     Update the configuration of a specific process within the specified project. Returns 409 if any
    attribute in the request is already linked to another process.
