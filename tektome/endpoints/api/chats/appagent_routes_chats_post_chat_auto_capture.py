...
from ...models.appagent_routes_chats_post_chat_auto_capture_response import (
    AppagentRoutesChatsPostChatAutoCaptureResponse,
)
...
) -> AppagentRoutesChatsPostChatAutoCaptureResponse | None:
    if response.status_code == 200:
        response_200 = AppagentRoutesChatsPostChatAutoCaptureResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AppagentRoutesChatsPostChatAutoCaptureResponse]:
    return Response(
