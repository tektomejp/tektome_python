...
from ...models.appresource_routers_bims_bims_elements_post_bim_search_query_bim_element_type_path import (
    AppresourceRoutersBimsBimsElementsPostBimSearchQueryBimElementTypePath,
)
...
def _get_kwargs(
    bim_type: AppresourceRoutersBimsBimsElementsPostBimSearchQueryBimElementTypePath,
    *,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        bim_type (AppresourceRoutersBimsBimsElementsPostBimSearchQueryBimElementTypePath): Enum
