...
from ...models.appresource_routers_bims_bims_elements_create_bim_resource_file_params import (
    AppresourceRoutersBimsBimsElementsCreateBimResourceFileParams,
)
...
def _get_kwargs(
    ...
    *,
    body: AppresourceRoutersBimsBimsElementsCreateBimResourceFileParams,
