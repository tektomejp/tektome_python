...
from ...models.appcore_routes_attributes_put_general_attributes_attribute_object_types import (
    AppcoreRoutesAttributesPutGeneralAttributesAttributeObjectTypes,
)
...
def _get_kwargs(
    object_type: AppcoreRoutesAttributesPutGeneralAttributesAttributeObjectTypes,
    object_id: UUID,
    *,
