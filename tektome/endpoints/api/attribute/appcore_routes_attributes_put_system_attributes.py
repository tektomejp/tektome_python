...
from ...models.appcore_routes_attributes_put_system_attributes_attribute_object_types import (
    AppcoreRoutesAttributesPutSystemAttributesAttributeObjectTypes,
)
...
def _get_kwargs(
    object_type: AppcoreRoutesAttributesPutSystemAttributesAttributeObjectTypes,
    object_id: UUID,
    *,
