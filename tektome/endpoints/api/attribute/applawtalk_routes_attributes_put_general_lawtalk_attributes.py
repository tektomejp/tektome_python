...
from ...models.applawtalk_routes_attributes_put_general_lawtalk_attributes_attribute_object_types import (
    ApplawtalkRoutesAttributesPutGeneralLawtalkAttributesAttributeObjectTypes,
)
...
def _get_kwargs(
    object_type: ApplawtalkRoutesAttributesPutGeneralLawtalkAttributesAttributeObjectTypes,
    object_id: UUID,
    *,
