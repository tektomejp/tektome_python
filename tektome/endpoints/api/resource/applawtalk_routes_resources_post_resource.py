...
from ...models.applawtalk_routes_resources_post_resource_multi_part_body_params import (
    ApplawtalkRoutesResourcesPostResourceMultiPartBodyParams,
)
...
def _get_kwargs(
    ...
    *,
    body: ApplawtalkRoutesResourcesPostResourceMultiPartBodyParams,
) -> dict[str, Any]:
