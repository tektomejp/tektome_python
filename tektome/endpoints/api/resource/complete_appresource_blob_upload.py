...
from ...models.blob_upload_complete_request import BlobUploadCompleteRequest
from ...models.blob_upload_complete_response import BlobUploadCompleteResponse
...
def _get_kwargs(
    project_id: UUID,
    *,
    body: BlobUploadCompleteRequest,
) -> dict[str, Any]:
...
) -> BlobUploadCompleteResponse | ErrorResponse | None:
    if response.status_code == 201:
        response_201 = BlobUploadCompleteResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[BlobUploadCompleteResponse | ErrorResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        project_id (UUID):
        body (BlobUploadCompleteRequest): Request to complete a blob upload.
...
def sync(
    ...
    *,
    ...
    Returns:
        BlobUploadCompleteResponse | ErrorResponse
    """
