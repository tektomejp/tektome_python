...
from ...models.appresource_routers_resource_version_control_router_create_resource_file_params import (
    AppresourceRoutersResourceVersionControlRouterCreateResourceFileParams,
)
...
def _get_kwargs(
    ...
    *,
    body: AppresourceRoutersResourceVersionControlRouterCreateResourceFileParams,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/core/resource-groups/{resource_group_id}/resources/version-control/".format(
