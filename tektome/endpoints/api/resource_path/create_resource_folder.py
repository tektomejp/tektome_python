...
from ...models.resource_folder_post_in import ResourceFolderPostIn
from ...models.resource_folder_post_out import ResourceFolderPostOut
...
def _get_kwargs(
    project_id: UUID,
    *,
    body: ResourceFolderPostIn,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/core/resource-paths/projects/{project_id}/folders/".format(
...
) -> GenericHttpError | ResourceFolderPostOut | None:
    if response.status_code == 201:
        response_201 = ResourceFolderPostOut.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GenericHttpError | ResourceFolderPostOut]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Create a resource folder
     ...
     Create an empty folder marker at the specified path within a project. The folder is represented by a
    .keep file at the given path.
...
def sync(
    ...
    *,
    ...
    Returns:
        GenericHttpError | ResourceFolderPostOut
    """
