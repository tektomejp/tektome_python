...
from ...models.create_resource_with_path_multi_part_body_params import CreateResourceWithPathMultiPartBodyParams
from ...models.generic_http_error import GenericHttpError
from ...models.resource_create_out import ResourceCreateOut
...
def _get_kwargs(
    project_id: UUID,
    *,
    body: CreateResourceWithPathMultiPartBodyParams,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/core/resource-paths/projects/{project_id}/resources/".format(
...
) -> GenericHttpError | ResourceCreateOut | None:
    if response.status_code == 201:
        response_201 = ResourceCreateOut.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GenericHttpError | ResourceCreateOut]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Create a resource with path

     Upload a file and create a resource at the specified path within a project. The path must be unique
    within the project.
...
def sync(
    ...
    *,
    ...
    Returns:
        GenericHttpError | ResourceCreateOut
    """
