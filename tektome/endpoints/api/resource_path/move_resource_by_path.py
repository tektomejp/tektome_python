...
from ...models.resource_move_in import ResourceMoveIn
from ...models.resource_move_out import ResourceMoveOut
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/core/resource-paths/projects/{project_id}/move/".format(
...
) -> GenericHttpError | ResourceMoveOut | None:
    if response.status_code == 200:
        response_200 = ResourceMoveOut.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GenericHttpError | ResourceMoveOut]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Move resource by path

     Move a resource or folder from one path to another. For folder paths (.keep files), recursively
    moves all resources under the folder.
...
def sync(
    ...
    *,
    ...
    Returns:
        GenericHttpError | ResourceMoveOut
    """
