...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/core/dataspaces/{dataspace_id}/attributes/{attribute_id}/rawtext-citations/".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create Attribute Rawtext Citation

     zRMnax11

    Create a raw text citation to an attribute.
