...
from ...models.citation_post_in import CitationPostIn
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/core/dataspaces/{dataspace_id}/attributes/{attribute_id}/attribute-citations/".format(
...
) -> AttributeCitationSchemaOut | ErrorOut | None:
    if response.status_code == 201:
        response_201 = AttributeCitationSchemaOut.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AttributeCitationSchemaOut | ErrorOut]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Create Attribute Citation From Another Attribute

     zRMnQQ1g

    Create an attribute citation based on another attribute.
...
def sync(
    ...
    *,
    ...
    Returns:
        AttributeCitationSchemaOut | ErrorOut
    """
