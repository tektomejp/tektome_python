...
from ...models.execution_approvals_response import ExecutionApprovalsResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/core/dataspaces/{dataspace_id}/approvals/{approval_id}/".format(
...
) -> ExecutionApprovalsResponse | GenericHttpError | None:
    if response.status_code == 200:
        response_200 = ExecutionApprovalsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ExecutionApprovalsResponse | GenericHttpError]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get approval ticket details
     ...
     Retrieve details of a specific approval ticket within a dataspace. Useful for polling the status of
    an approval ticket to check whether it has been approved or rejected.
...
def sync(
    ...
    *,
    ...
    Returns:
        ExecutionApprovalsResponse | GenericHttpError
    """
