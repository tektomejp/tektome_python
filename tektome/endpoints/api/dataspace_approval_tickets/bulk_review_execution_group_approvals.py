...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/core/dataspaces/{dataspace_id}/execution-groups/{execution_group_id}/approvals/bulk-review/".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Bulk review approvals in execution group

     Approve or reject all pending approval tickets within a specific execution group.
