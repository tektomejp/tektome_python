...
from ...models.bulk_move_folder_resources_schema import BulkMoveFolderResourcesSchema
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/core/folders/{folder_id}/bulk-move/".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        folder_id (UUID):
        body (BulkMoveFolderResourcesSchema): Schema for bulk move folders and resources by their
            IDs.
