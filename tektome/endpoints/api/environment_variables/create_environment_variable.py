...
from ...models.create_environment_variable_request import CreateEnvironmentVariableRequest
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = EnvironmentVariableResponse.from_dict(response.json())
