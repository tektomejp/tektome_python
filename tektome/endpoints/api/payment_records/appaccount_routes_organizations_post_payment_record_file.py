...
from ...models.appaccount_routes_organizations_post_payment_record_file_file_params import (
    AppaccountRoutesOrganizationsPostPaymentRecordFileFileParams,
)
...
def _get_kwargs(
    ...
    *,
    body: AppaccountRoutesOrganizationsPostPaymentRecordFileFileParams,
) -> dict[str, Any]:
