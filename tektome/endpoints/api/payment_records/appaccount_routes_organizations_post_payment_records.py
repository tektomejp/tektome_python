...
from ...models.appaccount_routes_organizations_post_payment_records_multi_part_body_params import (
    AppaccountRoutesOrganizationsPostPaymentRecordsMultiPartBodyParams,
)
...
def _get_kwargs(
    ...
    *,
    body: AppaccountRoutesOrganizationsPostPaymentRecordsMultiPartBodyParams,
) -> dict[str, Any]:
